import { getModularInstance, getUA, base64, isMobileCordova, isReactNative, isElectron, isIE, isUWP, isBrowserExtension } from '@firebase/util';
 ...
 */ class Rs {
    ...
    constructor(t, n, s) {
        ...
        // log on 12.2.
        12.2 === Rs._t(getUA()) && b("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    ...
    /** Returns true if IndexedDB is available in the current environment. */    static yt() {
        ...
        // Check the UA string to find out the browser.
                const t = getUA(), n = Rs._t(t), s = 0 < n && n < 10, i = Rs.Et(t), r = 0 < i && i < 4.5;
        // IE 10
...
function au(t, e, ...n) {
    if (t = getModularInstance(t), Jc("collection", "path", e), t instanceof ru) {
 ...
 * Firestore database.
 */ function fu(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), (t instanceof ou || t instanceof uu) && (e instanceof ou || e instanceof uu) && (t.firestore === e.firestore && t.path === e.path && t._converter === e._converter);
}
 ...
 * Firestore database.
 */ function du(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), t instanceof cu && e instanceof cu && (t.firestore === e.firestore && te(t._query, e._query) && t._converter === e._converter);
}
 ...
 */ function Wu(t, e) {
    ...
    // from firestore-exp.
    t = getModularInstance(t))) return Hu("Unsupported field value:", e, t), Gu(t, e);
    if (t instanceof Pu) 
 ...
 */ function Ju(t, e, n) {
    ...
    // FieldPath.
    e = getModularInstance(e)) instanceof bu) return e._internalPath;
...
function ga(t, e, n, s) {
    if (n[0] = getModularInstance(n[0]), n[0] instanceof ea) return function(t, e, n, s, i) {
 ...
 */ class ba {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = getModularInstance(e)) || e instanceof bu ? Ku(this._dataReader, "WriteBatch.update", i._key, e, n, s) : Qu(this._dataReader, "WriteBatch.update", i._key, e), 
 ...
 */ function Va(t, e, n, ...s) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = getModularInstance(e)) || e instanceof bu ? Ku(r, "updateDoc", t._key, e, n, s) : Qu(r, "updateDoc", t._key, e);
 ...
 */ class Na extends class {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = getModularInstance(e)) || e instanceof bu ? Ku(this._dataReader, "Transaction.update", i._key, e, n, s) : Qu(this._dataReader, "Transaction.update", i._key, e), 
...
class Ka {
    ...
    isEqual(t) {
        return (t = getModularInstance(t)) instanceof ou && fu(this._delegate, t);
    }
    set(t, e) {
 ...
 */ class eh {
    ...
    isEqual(t) {
        return (t = getModularInstance(t)) instanceof bu && this._delegate._internalPath.isEqual(t._internalPath);
    }
}
...
export { $a as $, Ba as B, Fa as F, Ha as H, Ja as J, Ka as K, Ma as M, O, Ua as U, Vu as V, Xa as X, Za as Z, eh as e, gu as g, ih as i, nh as n, qa as q, sh as s, yu as y, za as z };
//# sourceMappingURL=prebuilt.rn-31a90691.js.map
