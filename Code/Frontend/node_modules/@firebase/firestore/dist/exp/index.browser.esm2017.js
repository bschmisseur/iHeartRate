...
import { getUA as c, isMobileCordova as u, isReactNative as a, isElectron as h, isIE as l, isUWP as f, isBrowserExtension as d, getModularInstance as w } from "@firebase/util";

import { XhrIo as _, EventType as m, ErrorCode as g, createWebChannelTransport as y, getStatEventTarget as p, WebChannel as E, Event as T, Stat as I } from "@firebase/webchannel-wrapper";
...
/** An error returned by a Firestore operation. */ class P extends Error {
    /** @hideconstructor */
    constructor(t, e) {
 ...
 * limitations under the License.
 */
const b = new r("@firebase/firestore");
 ...
 */ class G extends W {
     ...
     */    static fromString(...t) {
        ...
        const e = [];
        for (const n of t) {
            if (n.indexOf("//") >= 0) throw new P(R.INVALID_ARGUMENT, `Invalid segment (${n}). Paths must not contain // in them.`);
...
/** A dot-separated path for navigating sub-objects within a document. */ class H extends W {
     ...
     */    static fromServerFormat(t) {
        ...
        let n = "", s = 0;
        const i = () => {
            if (0 === n.length) throw new P(R.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
            e.push(n), n = "";
        };
        let r = !1;
        for (;s < t.length; ) {
            const e = t[s];
            if ("\\" === e) {
                if (s + 1 === t.length) throw new P(R.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                const e = t[s + 1];
                if ("\\" !== e && "." !== e && "`" !== e) throw new P(R.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                n += e, s += 2;
            } else "`" === e ? (r = !r, s++) : "." !== e || r ? (n += e, s++) : (i(), s++);
        }
        if (i(), r) throw new P(R.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new H(e);
    }
    static emptyPath() {
        return new H([]);
 ...
 */ class J {
    ...
    isEqual(t) {
        return L(this.fields, t.fields, ((t, e) => t.isEqual(e)));
    }
}
...
const X = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
 ...
 */ function it(t) {
    const e = Z(t.mapValue.fields.__local_write_time__.timestampValue);
 ...
 */ class ut {
    ...
    static fromPath(t) {
        return new ut(G.fromString(t));
    }
    static fromName(t) {
        return new ut(G.fromString(t).popFirst(5));
    }
...
/** Extracts the backend's type order for the provided value. */ function at(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? nt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : x();
}
    ...
    switch (n) {
      ...
      case 3 /* TimestampValue */ :
        return function(t, e) {
            ...
            const n = Z(t.timestampValue), s = Z(e.timestampValue);
      ...
      case 9 /* ArrayValue */ :
        return L(t.arrayValue.values || [], e.arrayValue.values || [], ht);
...
function ft(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            const n = F(tt(t.latitude), tt(e.latitude));
            if (0 !== n) return n;
            return F(tt(t.longitude), tt(e.longitude));
...
function dt(t, e) {
    ...
    const n = Z(t), s = Z(e), i = F(n.seconds, s.seconds);
 ...
 */ class Rt {
     ...
     */    static newInvalidDocument(t) {
        return new Rt(t, 0 /* INVALID */ , U.min(), It.empty(), 0 /* SYNCED */);
    }
    /**
 ...
 */ function ee(t) {
    ...
    if (null === e.p) {
        ...
        t.isKeyField() || e.p.push(new Kt(t)), e.p.push(new Kt(H.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
...
function be(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof ye && e instanceof ye || t instanceof Ee && e instanceof Ee ? L(t.elements, e.elements, ht) : t instanceof Ie && e instanceof Ie ? ht(t.A, e.A) : t instanceof ge && e instanceof ge;
...
function ke(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.precondition.isEqual(e.precondition) && (!!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && L(t, e, ((t, e) => be(t, e)));
...
function Ge(t) {
    ...
    return D("GRPC error has no .code"), R.UNKNOWN;
    switch (t) {
      case Qe.OK:
        return R.OK;
...
class Je {
    ...
    check() {
        if (this.isRed() && this.left.isRed()) throw x();
        if (this.right.isRed()) throw x();
        const t = this.left.check();
        if (t !== this.right.check()) throw x();
 ...
 */ class hn {
    ...
    static createSynthesizedRemoteEventForCurrentChange(t, e) {
        const n = new Map;
        return n.set(t, ln.createSynthesizedTargetChangeForCurrentChange(t, e)), new hn(U.min(), n, an(), tn(), cn());
    }
}
 ...
 */ class ln {
     ...
     */    static createSynthesizedTargetChangeForCurrentChange(t, e) {
        return new ln(Y.EMPTY_BYTE_STRING, e, cn(), cn(), cn());
    }
}
...
class mn {
     ...
     */    rt(t) {
        ...
        if (s) {
            ...
            if (Dt(t)) if (0 === n) {
                ...
                this.tt(e, n, Rt.newNoDocument(n, U.min()));
            } else k(1 === n); else {
                this.ct(e) !== n && (
     ...
     */    ut(t) {
        ...
        return this.H = tn(), this.J = gn(), this.Y = new Ye(F), s;
    }
    /**
    ...
    ht(t) {
        let e = this.J.get(t);
        return e || (e = new Ye(F), this.J = this.J.insert(t, e)), e;
    }
    /**
...
function Pn(t) {
    return k(!!t), U.fromTimestamp(function(t) {
        const e = Z(t);
        return new q(e.seconds, e.nanos);
    }(t));
}
...
function Sn(t, e) {
    const n = vn(e);
    if (n.get(1) !== t.databaseId.projectId) throw new P(R.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.databaseId.projectId);
    if (n.get(3) !== t.databaseId.database) throw new P(R.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.databaseId.database);
    return new ut(xn(n));
}
...
function Cn(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? G.emptyPath() : xn(e);
}
...
function Mn(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            return t.I ? (k(void 0 === e || "string" == typeof e), Y.fromBase64String(e || "")) : (k(void 0 === e || e instanceof Uint8Array), 
            Y.fromUint8Array(e || new Uint8Array));
        }(t, e.targetChange.resumeToken), o = e.targetChange.cause, c = o && function(t) {
            const e = void 0 === t.code ? R.UNKNOWN : Ge(t.code);
 ...
 */ (o);
        ...
        s.document;
        const i = Sn(t, s.document), r = s.readTime ? Pn(s.readTime) : U.min(), o = Rt.newNoDocument(i, r), c = s.removedTargetIds || [];
        n = new fn([], c, o.key, o);
...
function Ln(t, e) {
    const n = e.currentDocument ? function(t) {
        ...
        let n = null;
        if ("setToServerValue" in e) k("REQUEST_TIME" === e.setToServerValue), n = new ge; else if ("appendMissingElements" in e) {
            const t = e.appendMissingElements.values || [];
            n = new ye(t);
        } else if ("removeAllFromArray" in e) {
            const t = e.removeAllFromArray.values || [];
            n = new Ee(t);
        } else "increment" in e ? n = new Ie(t, e.increment) : x();
        const s = H.fromServerFormat(e.fieldPath);
        return new Pe(s, n);
    }(t, e))) : [];
    if (e.update) {
        e.update.name;
        ...
        if (e.updateMask) {
            const t = function(t) {
                ...
                return new J(e.map((t => H.fromServerFormat(t))));
            }(e.updateMask);
...
function Bn(t, e) {
    return t && t.length > 0 ? (k(void 0 !== e), t.map((t => function(t, e) {
...
function jn(t) {
    return t ? void 0 !== t.unaryFilter ? [ Zn(t) ] : void 0 !== t.fieldFilter ? [ Xn(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => jn(t))).reduce(((t, e) => t.concat(e))) : x() : [];
}
 ...
 */ function rs(t) {
    ...
    const e = t.length;
    if (k(e >= 2), 2 === e) return k("" === t.charAt(0) && "" === t.charAt(1)), G.emptyPath();
 ...
 */ class bs {
    ...
    next(t, e) {
        return this.callbackAttached && x(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new bs(((n, s) => {
            this.nextCallback = e => {
...
class vs {
    ...
    abort(t) {
        t && this.ft.reject(t), this.aborted || (S("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
 ...
 */ class Vs {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === Vs._t(c()) && D("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    static delete(t) {
        return S("SimpleDb", "Removing database:", t), xs(window.indexedDB.deleteDatabase(t)).toPromise();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static gt() {
        ...
        // Check the UA string to find out the browser.
                const t = c(), e = Vs._t(t), n = 0 < e && e < 10, s = Vs.Et(t), i = 0 < s && s < 4.5;
        // IE 10
     ...
     */    async At(t) {
        return this.db || (S("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                "VersionError" === s.name ? n(new P(R.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new Ds(t, s));
            }, s.onupgradeneeded = t => {
                S("SimpleDb", 'Database "' + this.name + '" requires upgrade from version:', t.oldVersion);
                const e = t.target.result;
                this.wt.Rt(e, s.transaction, t.oldVersion, this.version).next((() => {
                    S("SimpleDb", "Database upgrade to version " + this.version + " complete");
                }));
            };
    ...
    async runTransaction(t, e, n, s) {
        ...
        for (;;) {
            ...
            try {
                ...
                if (S("SimpleDb", "Transaction failed with error:", t.message, "Retrying:", e), 
...
/** An error that wraps exceptions that thrown during IndexedDB execution. */ class Ds extends P {
    constructor(t, e) {
        super(R.UNAVAILABLE, `IndexedDB transaction '${t}' failed: ${e}`), this.name = "IndexedDbTransactionError";
    }
}
 ...
 */ class Ns {
    ...
    put(t, e) {
        let n;
        return void 0 !== e ? (S("SimpleDb", "PUT", this.store.name, t, e), n = this.store.put(e, t)) : (S("SimpleDb", "PUT", this.store.name, "<auto-key>", t), 
     ...
     */    add(t) {
        S("SimpleDb", "ADD", this.store.name, t, t);
     ...
     */    get(t) {
        ...
        void 0 === e && (e = null), S("SimpleDb", "GET", this.store.name, t, e), e)));
    }
    delete(t) {
        S("SimpleDb", "DELETE", this.store.name, t);
     ...
     */    count() {
        S("SimpleDb", "COUNT", this.store.name);
    ...
    kt(t, e) {
        S("SimpleDb", "DELETE ALL", this.store.name);
...
function Os(t) {
    ...
    if (e >= 12.2 && e < 13) {
        ...
        if (t.message.indexOf(e) >= 0) {
            ...
            const t = new P("internal", `IOS_INDEXEDDB_BUG1: IndexedDb has thrown '${e}'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.`);
            return ks || (ks = !0, 
 ...
 */ class Fs {
     ...
     */    applyToLocalDocumentSet(t) {
        ...
        this.mutations.forEach((e => {
            ...
            // and we should remove this cast.
                        this.applyToLocalView(s), n.isValidDocument() || s.convertToNoDocument(U.min());
        }));
    }
    keys() {
    ...
    isEqual(t) {
        return this.batchId === t.batchId && L(this.mutations, t.mutations, ((t, e) => ke(t, e))) && L(this.baseMutations, t.baseMutations, ((t, e) => ke(t, e)));
    }
}
...
function zs(t, e) {
    ...
    const s = e.mutations.map((e => Ln(t.Lt, e))), i = q.fromMillis(e.localWriteTimeMs);
    return new Fs(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function Hs(t) {
    const e = Gs(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? Gs(t.lastLimboFreeSnapshotVersion) : U.min();
    let s;
    var i;
    return void 0 !== t.query.documents ? (k(1 === (i = t.query).documents.length), 
    s = ne(Ht(Cn(i.documents[0])))) : s = function(t) {
        return ne(Kn(t));
    }(t.query), new Bs(s, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, n, Y.fromBase64String(t.resumeToken));
}
 ...
 */ class ni {
    ...
    add(t) {
        const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new Ye(G.comparator), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new Ye(G.comparator)).toArray();
    }
}
...
class ai {
    ...
    addMutationBatch(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            ...
            let h = new Ye(((t, e) => F(t.canonicalString(), e.canonicalString())));
            for (const t of s) {
    ...
    lookupMutationBatch(t, e) {
        return li(t).get(e).next((t => t ? (k(t.userId === this.userId), zs(this.R, t)) : null));
    }
    /**
    ...
    getNextMutationBatchAfterBatchId(t, e) {
        ...
        return li(t).$t({
            ...
            e.userId === this.userId && (k(e.batchId >= n), i = zs(this.R, e)), s.done();
        })).next((() => i));
    }
    ...
    getAllMutationBatchesAffectingDocumentKey(t, e) {
        ...
        return fi(t).$t({
            ...
            return li(t).get(u).next((t => {
                if (!t) throw x();
                k(t.userId === this.userId), i.push(zs(this.R, t));
            }));
            r.done();
        })).next((() => i));
    }
    ...
    Wt(t, e) {
        ...
        return e.forEach((e => {
            s.push(li(t).get(e).next((t => {
                if (null === t) throw x();
                k(t.userId === this.userId), n.push(zs(this.R, t));
            })));
        })), bs.waitFor(s).next((() => n));
    }
 ...
 */ class _i {
    ...
    getLastRemoteSnapshotVersion(t) {
        return this.Xt(t).next((t => U.fromTimestamp(new q(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds))));
    }
    ...
    removeTargetData(t, e) {
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((() => mi(t).delete(e.targetId))).next((() => this.Xt(t))).next((e => (k(e.targetCount > 0), 
    ...
    Xt(t) {
        return gi(t).get(gs.key).next((t => (k(null !== t), t)));
    }
    Zt(t, e) {
 ...
 */ async function pi(t) {
    if (t.code !== R.FAILED_PRECONDITION || t.message !== As) throw t;
    S("LocalStore", "Unexpectedly lost primary lease");
}
 ...
 */ class Ii {
    ...
    ue(t) {
        ...
        S("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.ce = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            this.ce = null, this.oe = !0;
            try {
                await t.collectGarbage(this.garbageCollector);
            } catch (t) {
                Cs(t) ? S("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await pi(t);
            }
            await this.ue(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class Ai {
    ...
    collect(t, e) {
        return -1 === this.params.cacheSizeCollectionThreshold ? (S("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        bs.resolve(ri)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? (S("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
        ri) : this.fe(t, e)));
    }
    getCacheSize(t) {
    ...
    fe(t, e) {
        ...
        e > this.params.maximumSequenceNumbersToCollect ? (S("LruGarbageCollector", `Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${e}`), 
 ...
 */ class Vi {
    ...
    getMetadata(t) {
        return Di(t).get(ws.key).next((t => (k(!!t), t)));
    }
    me(t, e) {
     ...
     */    ge(t, e) {
        if (e) {
            ...
            // `getNewDocumentChanges()`
                        if (!(t.isNoDocument() && t.version.isEqual(U.min()))) return t;
        }
...
class Si extends vi {
    ...
    applyChanges(t) {
        const e = [];
        let n = 0, s = new Ye(((t, e) => F(t.canonicalString(), e.canonicalString())));
        return this.changes.forEach(((i, r) => {
            ...
            if (r.document.isValidDocument()) {
                ...
                const n = Ks(this.Ie.R, Rt.newNoDocument(i, U.min()), this.getReadTime(i));
...
class $i {
    ...
    a) {
        ...
        this.Fe = t => Promise.resolve(), !$i.gt()) throw new P(R.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
 ...
 */
        ...
        !1 === a && D("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
    }
    /**
     ...
     */    start() {
        ...
        return this.je().then((() => {
            ...
            throw new P(R.FAILED_PRECONDITION, Oi);
     ...
     */    je() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t => Fi(t).put(new ps(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next((() => {
            ...
            return S("IndexedDbPersistence", "Failed to extend owner lease: ", t), this.isPrimary;
            if (!this.allowTabSynchronization) throw t;
            return S("IndexedDbPersistence", "Releasing owner lease after error during lease refresh", t), 
            /* isPrimary= */ !1;
        })).then((t => {
     ...
     */    Ye(t) {
        ...
        })).next((t => (this.isPrimary !== t && S("IndexedDbPersistence", `Client ${t ? "is" : "is not"} eligible for a primary lease.`), 
        t)));
    }
    async shutdown() {
    ...
    runTransaction(t, e, n) {
        S("IndexedDbPersistence", "Starting transaction:", t);
        const s = "readonly" === e ? "readonly" : "readwrite";
        let i;
        // Do all transactions as readwrite against all object stores, since we
        // are the only reader/writer.
                return this.Be.runTransaction(t, s, Is, (s => (i = new $s(s, this.Ne ? this.Ne.next() : A.o), 
        "readwrite-primary" === e ? this.Je(i).next((t => !!t || this.Ye(i))).next((e => {
            if (!e) throw D(`Failed to obtain primary lease for action '${t}'.`), this.isPrimary = !1, 
            this.Se.enqueueRetryable((() => this.Fe(!1))), new P(R.FAILED_PRECONDITION, As);
            return n(i);
    ...
    dn(t) {
        return Mi(t).get(cs.key).next((t => {
            if (null !== t && this.sn(t.leaseTimestampMs, 5e3) && !this.cn(t.ownerId) && !this.tn(t) && !(this.Ce || this.allowTabSynchronization && t.allowTabSynchronization)) throw new P(R.FAILED_PRECONDITION, Oi);
        }));
    }
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */    Xe(t) {
        const e = Mi(t);
        return e.get(cs.key).next((t => this.tn(t) ? (S("IndexedDbPersistence", "Releasing primary lease."), 
     ...
     */    cn(t) {
        ...
        try {
            ...
            return S("IndexedDbPersistence", `Client '${t}' ${n ? "is" : "is not"} zombied in LocalStorage`), 
            n;
        } catch (t) {
 ...
 */ class Ki {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        }(e) || n.isEqual(U.min()) ? this.Dn(t, e) : this.Sn.pn(t, s).next((i => {
            const r = this.Cn(e, i);
            return (Jt(e) || Yt(e)) && this.Nn(e.limitType, r, s, n) ? this.Dn(t, e) : (v() <= o.DEBUG && S("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), oe(e)), 
    ...
    Dn(t, e) {
        return v() <= o.DEBUG && S("QueryEngine", "Using full collection scan to execute query:", oe(e)), 
...
class Qi {
    ...
    t, e, n, s) {
         ...
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.$n = U.min(), this._n = t.getMutationQueue(n), this.Mn = t.getRemoteDocumentCache(), 
        ...
        return function(t, e, n, s) {
            ...
            return r.forEach((t => {
                o = o.next((() => s.getEntry(e, t))).next((e => {
                    ...
                    k(null !== r), e.version.compareTo(r) < 0 && (i.applyToRemoteDocument(e, n), e.isValidDocument() && 
 ...
 * queue.
 */ function Hi(t, e) {
    const n = O(t), s = e.snapshotVersion;
    let i = n.kn;
 ...
 */
                function(t, e, n) {
                    ...
                    if (k(e.resumeToken.approximateByteSize() > 0), 0 === t.resumeToken.approximateByteSize()) return !0;
...
i) {
    ...
    return n.forEach((t => r = r.add(t))), e.getEntries(t, r).next((t => {
        ...
        return n.forEach(((n, o) => {
            ...
            r = r.insert(n, o)) : S("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", c.version, " Watch version:", o.version);
        })), r;
    }));
}
...
async function Zi(t, e, n) {
    const s = O(t), i = s.kn.get(e), r = n ? "readwrite" : "readwrite-primary";
    try {
        ...
        S("LocalStore", `Failed to update sequence numbers for target ${e}: ${t}`);
    }
 ...
 */ function tr(t, e, n) {
    ...
    })).next((() => s.xn.getDocumentsMatchingQuery(t, e, n ? i : U.min(), n ? r : cn()))).next((t => ({
        documents: t,
        Bn: r
    })))));
}
...
// PORTING NOTE: Multi-Tab only.
function er(t, e) {
    const n = O(t), s = O(n.qe), i = n.kn.get(e);
...
async function ir(t, e, n, s) {
    ...
    const u = i.Mn.newChangeBuffer({
        ...
        return ne(Ht(G.fromString(`__bundle__/docs/${t}`)));
    }(s));
    // Allocates a target to hold all document keys from the bundle, such that
    // they will not get garbage collected right away.
        return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t => Ji(t, u, o, U.min(), c).next((e => (u.apply(t), 
...
async function rr(t, e, n = cn()) {
    ...
    const s = await Xi(t, ne(Ys(e.bundledQuery))), i = O(t);
    return i.persistence.runTransaction("Save named query", "readwrite", (t => {
        ...
        // Update existing target data because the query from the bundle is newer.
                const o = s.withResumeToken(Y.EMPTY_BYTE_STRING, r);
 ...
 */ class cr {
     ...
     * removed.
     */    Zn(t) {
        const e = new ut(new G([])), n = new ur(e, t), s = new ur(e, t + 1), i = [];
    ...
    es(t) {
        const e = new ut(new G([])), n = new ur(e, t), s = new ur(e, t + 1);
        let i = cn();
        return this.zn.forEachInRange([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
 ...
 */ class ar {
    ...
    removeMutationBatch(t, e) {
        k(0 === this.hs(e.batchId, "removed")), this._n.shift();
        let n = this.rs;
...
class dr {
     ...
     */
    constructor(t, e) {
        this.ys = {}, this.Ne = new A(0), this.xe = !1, this.xe = !0, this.referenceDelegate = t(this), 
        this.qe = new fr(this);
...
class Er {
     ...
     */    static Vs(t, e, n) {
        ...
        r && (i = new P(s.error.code, s.error.message))), r ? new Er(t, e, s.state, i) : (D("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    Ss() {
        const t = {
...
class Tr {
     ...
     */    static Vs(t, e) {
        ...
        i && (s = new P(n.error.code, n.error.message))), i ? new Tr(t, n.state, s) : (D("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    Ss() {
        const t = {
 ...
 */ class Ir {
     ...
     */    static Vs(t, e) {
        ...
        return s ? new Ir(t, i) : (D("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class Ar {
     ...
     */    static Vs(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Ar(e.clientId, e.onlineState) : (D("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class Pr {
    constructor(t, e, n, s, i) {
        ...
        this.Os = new ze(F), this.started = !1, 
        /**
 ...
 */ (this.persistenceKey), this.Os = this.Os.insert(this.Ns, new Rr), this.Ls = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
    ...
    getItem(t) {
        ...
        return S("SharedClientState", "READ", t, e), e;
    }
    setItem(t, e) {
        S("SharedClientState", "SET", t, e), this.storage.setItem(t, e);
    }
    removeItem(t) {
        S("SharedClientState", "REMOVE", t), this.storage.removeItem(t);
    }
    ks(t) {
        ...
        if (e.storageArea === this.storage) {
            if (S("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.Ms) return void D("Received WebStorage notification for local change. Another client might have garbage-collected our state");
 ...
 */ (e.newValue);
                        t !== A.o && this.sequenceNumberHandler(t);
    ...
    async ii(t) {
        ...
        S("SharedClientState", `Ignoring mutation for non-active user ${t.user.uid}`);
    }
    oi(t) {
...
class {
    ...
    Ni(t, e, n, s) {
        ...
        const r = {};
        return this.ki(r, s), this.Oi(t, i, r, n).then((t => (S("RestConnection", "Received: ", t), 
        t)), (e => {
            ...
            o.listenOnce(m.COMPLETE, (() => {
                try {
                    switch (o.getLastErrorCode()) {
                      ...
                      case g.TIMEOUT:
                        S("Connection", 'RPC "' + t + '" timed out'), r(new P(R.DEADLINE_EXCEEDED, "Request time out"));
                        break;

                      case g.HTTP_ERROR:
                        const n = o.getStatus();
                        if (S("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", o.getResponseText()), 
                        n > 0) {
                            ...
                            if (t && t.status && t.message) {
                                ...
                                r(new P(e, t.message));
                            } else r(new P(R.UNKNOWN, "Server responded with status " + o.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        r(new P(R.UNAVAILABLE, "Connection failed."));
                        break;
    ...
    Mi(t, e) {
        const n = [ this.Di, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], s = y(), i = p(), r = {
        ...
        u() || a() || h() || l() || f() || d() || (r.httpHeadersOverwriteParam = "$httpHeaders");
        const o = n.join("");
        S("Connection", "Creating WebChannel: " + o, r);
        ...
        // on a closed stream
                const m = new Dr({
            Ei: t => {
                _ ? S("Connection", "Not sending because WebChannel is closed:", t) : (w || (S("Connection", "Opening WebChannel transport."), 
                c.open(), w = !0), S("Connection", "WebChannel sending:", t), c.send(t));
            },
            Ti: () => c.close()
        }), g = (t, e, n) => {
        ...
        // enough the code is exception free.
                return g(c, E.EventType.OPEN, (() => {
            _ || S("Connection", "WebChannel transport opened.");
        })), g(c, E.EventType.CLOSE, (() => {
            _ || (_ = !0, S("Connection", "WebChannel transport closed"), m.Vi());
        })), g(c, E.EventType.ERROR, (t => {
            _ || (_ = !0, C("Connection", "WebChannel transport errored:", t), m.Vi(new P(R.UNAVAILABLE, "The operation could not be completed")));
        })), g(c, E.EventType.MESSAGE, (t => {
            var e;
            if (!_) {
                const n = t.data[0];
                k(!!n);
 ...
 */
                    ...
                    void 0 === e && (e = R.INTERNAL, n = "Unknown error status: " + t + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    _ = !0, m.Vi(new P(e, n)), c.close();
                } else S("Connection", "WebChannel received:", n), m.Si(n);
            }
        })), g(i, T.STAT_EVENT, (t => {
            t.stat === I.PROXY ? S("Connection", "Detected buffering proxy") : t.stat === I.NOPROXY && S("Connection", "Detected no buffering proxy");
        })), setTimeout((() => {
...
class Or {
     ...
     */    ji(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                s > 0 && S("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.qi} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
...
class $r {
    ...
    auth() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            t((() => {
                const t = new P(R.UNKNOWN, "Fetching auth token failed: " + e.message);
                return this.dr(t);
            }));
        }));
    }
     ...
     */    hr(t) {
        return e => {
            this.Se.enqueueAndForget((() => this.Yi === t ? e() : (S("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve())));
        };
    }
}
 ...
 */ class Mr extends $r {
    ...
    onMessage(t) {
        ...
        const e = Mn(this.R, t), n = function(t) {
            ...
            return e.targetIds && e.targetIds.length ? U.min() : e.readTime ? Pn(e.readTime) : U.min();
        }(t);
     ...
     */    mr(t) {
        ...
        e.database = Nn(this.R), e.addTarget = function(t, e) {
            ...
            return n = Dt(s) ? {
                ...
                query: Un(t, s)
            }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = An(t, e.resumeToken) : e.snapshotVersion.compareTo(U.min()) > 0 && (
 ...
 */ class Fr extends $r {
    ...
    onMessage(t) {
        ...
        k(!!t.streamToken), this.lastStreamToken = t.streamToken, this.yr) {
        ...
        return k(!t.writeResults || 0 === t.writeResults.length), this.yr = !0, this.listener.Ir();
    }
    /**
...
class Lr extends class {} {
    ...
    Pr() {
        if (this.Rr) throw new P(R.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    /** Gets an auth token and invokes the provided RPC. */    Ni(t, e, n) {
        return this.Pr(), this.credentials.getToken().then((s => this.Hi.Ni(t, e, n, s))).catch((t => {
            throw t.code === R.UNAUTHENTICATED && this.credentials.invalidateToken(), t;
        }));
    }
    ...
    e, n, s, i) {
        ...
        this.Fr = [], this.Lr = i, this.Lr.di((t => {
            n.enqueueAndForget((async () => {
                ...
                // down our streams.
                Jr(this) && (S("RemoteStore", "Restarting streams for network reachability change."), 
 ...
 */ (t, e);
        ...
        S("RemoteStore", "Failed to remove targets %s: %s ", e.targetIds.join(","), n), 
        await eo(t, n);
 ...
 */
        ...
        S("RemoteStore", "Failed to raise snapshot:", e), await eo(t, e);
    }
}
 ...
 */ async function eo(t, e, n) {
    ...
    t.asyncQueue.enqueueRetryable((async () => {
        S("RemoteStore", "Retrying IndexedDB access"), await n(), t.Mr.delete(1 /* IndexedDbFailed */), 
        await Ur(t);
    }));
}
 ...
 */ function _o(t) {
    ...
    t.Kr = function(t, e, n) {
        ...
        await so(t)) : (await t.Kr.stop(), t.Or.length > 0 && (S("RemoteStore", `Stopping write stream with ${t.Or.length} pending writes`), 
        t.Or = []));
    }))), t.Kr;
}
...
class mo {
     ...
     */    cancel(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new P(R.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    handleDelayElapsed() {
 ...
 */ function go(t, e) {
    if (D("AsyncQueue", `${e}: ${t}`), Cs(t)) return new P(R.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
...
/** Stops listening to the query. */ async function qo(t, e) {
    const n = O(t), s = n.vo.get(e), i = n.Vo.get(s.targetId);
 ...
 */ async function Uo(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            const n = O(t), s = q.now(), i = e.reduce(((t, e) => t.add(e.key)), cn());
            let r;
 ...
 */ async function Ko(t, e) {
    ...
    try {
        ...
        // Update `receivedDocument` as appropriate for any limbo targets.
            ...
            t.addedDocuments.size > 0 ? s.Po = !0 : t.modifiedDocuments.size > 0 ? k(s.Po) : t.removedDocuments.size > 0 && (k(s.Po), 
            s.Po = !1));
        })), await nc(n, t, e);
    } catch (t) {
        await pi(t);
 ...
 */ async function jo(t, e, n) {
    ...
    if (r) {
        ...
        t = t.insert(r, Rt.newNoDocument(r, U.min()));
        const n = cn().add(r), i = new hn(U.min(), 
        /* targetChanges= */ new Map, 
        /* targetMismatches= */ new Ye(F), t, n);
        await Ko(s, i), 
    ...
    try {
        const t = await function(t, e) {
            ...
            return n.persistence.runTransaction("Reject batch", "readwrite-primary", (t => {
                let s;
                return n._n.lookupMutationBatch(t, e).next((e => (k(null !== e), s = e.keys(), n._n.removeMutationBatch(t, e)))).next((() => n._n.performConsistencyCheck(t))).next((() => n.Fn.pn(t, s)));
            }));
        }
        /**
 ...
 */ async function zo(t, e) {
    const n = O(t);
    Jr(n.remoteStore) || S("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
    try {
...
function Zo(t, e, n) {
    for (const s of n) if (s instanceof xo) t.No.addReference(s.key, e), tc(t, s); else if (s instanceof ko) {
        S("SyncEngine", "Document no longer in limbo: " + s.key), t.No.removeReference(s.key, e);
...
function tc(t, e) {
    ...
    t.Do.get(n) || t.So.has(s) || (S("SyncEngine", "New document in limbo: " + n), t.So.add(s), 
    ec(t));
}
 ...
 */ function ec(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.So.delete(e);
        const n = new ut(G.fromString(e)), s = t.Oo.next();
        t.Co.set(s, new Mo(n)), t.Do = t.Do.insert(n, s), Qr(t.remoteStore, new Bs(ne(Ht(n.path)), s, 2 /* LimboResolution */ , A.o));
    }
}
...
async function nc(t, e, n) {
    ...
    s.vo.isEmpty() || (s.vo.forEach(((t, c) => {
        ...
        try {
            ...
            S("LocalStore", "Failed to update sequence numbers: " + t);
        }
        for (const t of e) {
            const e = t.targetId;
            if (!t.fromCache) {
...
async function sc(t, e) {
    ...
    if (!n.currentUser.isEqual(e)) {
        S("SyncEngine", "User change. New user:", e.toKey());
 ...
 */ async function rc(t, e) {
    const n = O(t), s = await tr(n.localStore, e.query, 
...
async function cc(t, e, n, s) {
    const i = O(t), r = await function(t, e) {
        const n = O(t), s = O(n._n);
    ...
    // as applicable.
    S("SyncEngine", "Cannot apply mutation batch with id: " + e);
}
...
async function ac(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            for (const t of n) {
                const e = s.vo.get(t), n = await rc(s, e);
...
async function fc(t, e, n, s) {
    ...
    S("SyncEngine", "Ignoring unexpected query state notification."); else if (i.Vo.has(e)) switch (n) {
      case "current":
      case "not-current":
        {
    ...
    if (s.$o) {
        for (const t of e) {
            if (s.Vo.has(t)) {
                ...
                S("SyncEngine", "Adding an already active target " + t);
                continue;
            }
 ...
 */ class pc extends yc {
    ...
    Bo(t) {
        const e = Nr();
        if (!Pr.gt(e)) throw new P(R.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
 ...
 */ class Ec {
    ...
    terminate() {
        return async function(t) {
            const e = O(t);
            S("RemoteStore", "RemoteStore shutting down."), e.Mr.add(5 /* Shutdown */), await Kr(e), 
            e.Lr.shutdown(), 
...
class Rc {
    ...
    async lookup(t) {
        if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new P(R.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        const e = await async function(t, e) {
            const n = O(t), s = Nn(n.R) + "/documents", i = {
...
class bc {
    ...
    e, n) {
        ...
        this.clientId = M.u(), this.credentialListener = () => {}, this.receivedInitialUser = new Ps, 
        this.credentials.setChangeListener((t => {
            S("FirestoreClient", "Received user=", t.uid), this.user = t, this.credentialListener(t), 
     ...
     */    verifyNotTerminated() {
        if (this.asyncQueue.isShuttingDown) throw new P(R.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    terminate() {
...
async function vc(t, e) {
    t.asyncQueue.verifyOperationInProgress(), S("FirestoreClient", "Initializing OfflineComponentProvider");
...
async function Vc(t, e) {
    ...
    const n = await Sc(t);
    S("FirestoreClient", "Initializing OnlineComponentProvider");
    ...
    t.setCredentialChangeListener((n => t.asyncQueue.enqueueRetryable((() => async function(t, e) {
        const n = O(t);
        n.asyncQueue.verifyOperationInProgress(), S("RemoteStore", "RemoteStore received new credentials");
        const s = Jr(n);
...
async function Sc(t) {
    return t.offlineComponents || (S("FirestoreClient", "Using default OfflineComponentProvider"), 
    await vc(t, new gc)), t.offlineComponents;
}

async function Dc(t) {
    return t.onlineComponents || (S("FirestoreClient", "Using default OnlineComponentProvider"), 
...
/** Disables the network connection. Pending operations will not complete. */ function Mc(t) {
    return t.asyncQueue.enqueue((async () => {
        const e = await Cc(t), n = await xc(t);
 ...
 */ function Fc(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
        try {
            ...
            s.isFoundDocument() ? n.resolve(s) : s.isNoDocument() ? n.resolve(null) : n.reject(new P(R.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"));
        } catch (t) {
...
function Lc(t, e, n = {}) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        ...
        return Ao(t, o);
    }(await Oc(t), t.asyncQueue, e, n, s))), s.promise;
}
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new Ic({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.enqueueAndForget((() => Ro(t, o))), n.fromCache && "server" === s.source ? i.reject(new P(R.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Vo(n, r, {
            includeMetadataChanges: !0,
...
class Yc {
    ...
    getToken() {
        ...
        this.cc !== t ? (S("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
        this.getToken()) : e ? (k("string" == typeof e.accessToken), new Hc(e.accessToken, this.currentUser)) : null)) : Promise.resolve(null);
    }
    invalidateToken() {
        this.forceRefresh = !0;
    }
    ...
    uc() {
        ...
        return k(null === t || "string" == typeof t), new mr(t);
    }
}
 ...
 */ class Xc {
    constructor(t, e) {
        this.ac = t, this.hc = e, this.type = "FirstParty", this.user = mr.FIRST_PARTY;
    }
    get authHeaders() {
        const t = {
 ...
 */ class Zc {
    ...
    getToken() {
        return Promise.resolve(new Xc(this.ac, this.hc));
    }
    setChangeListener(t) {
 ...
 */
function eu(t) {
    if (!ut.isDocumentKey(t)) throw new P(R.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ function nu(t) {
    if (ut.isDocumentKey(t)) throw new P(R.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
}
...
class ou {
    constructor(t) {
        ...
        function(t, e, n, s) {
            if (!0 === e && !0 === s) throw new P(R.INVALID_ARGUMENT, `${t} and ${n} cannot be used together.`);
 ...
 */ class cu {
    ...
    constructor(t, e) {
        ...
        t instanceof Gc ? (this._databaseId = t, this._credentials = new Jc) : (this._app = t, 
 ...
 */ (t), this._credentials = new Yc(e));
    }
    /**
     * The {@link FirebaseApp} associated with this `Firestore` service
     * instance.
     */    get app() {
        if (!this._app) throw new P(R.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this._app;
    }
    get _initialized() {
    ...
    _setSettings(t) {
        if (this._settingsFrozen) throw new P(R.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
 ...
 */
        return function(t) {
            const e = zc.get(t);
            e && (S("ComponentProvider", "Removing Datastore"), zc.delete(t), e.terminate());
...
function fu(t, e, ...n) {
    if (t = w(t), tu("collection", "path", e), t instanceof cu) {
        const s = G.fromString(e, ...n);
        return nu(s), new lu(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof au || t instanceof lu)) throw new P(R.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = G.fromString(t.path, ...n).child(G.fromString(e));
 ...
 */ function du(t, e) {
    if (t = iu(t, cu), tu("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new P(R.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new hu(t, 
    /* converter= */ null, 
    /**
...
function wu(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = M.u()), tu("doc", "path", e), t instanceof cu) {
        const s = G.fromString(e, ...n);
    ...
    {
        if (!(t instanceof au || t instanceof lu)) throw new P(R.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(G.fromString(e, ...n));
 ...
 * Firestore database.
 */ function _u(t, e) {
    return t = w(t), e = w(e), (t instanceof au || t instanceof lu) && (e instanceof au || e instanceof lu) && (t.firestore === e.firestore && t.path === e.path && t._converter === e._converter);
}
 ...
 * Firestore database.
 */ function mu(t, e) {
    return t = w(t), e = w(e), t instanceof hu && e instanceof hu && (t.firestore === e.firestore && ie(t._query, e._query) && t._converter === e._converter);
}
 ...
 */ class gu {
    constructor() {
        ...
        this.yc = () => {
            const t = xr();
            t && S("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.Zi.Gi();
        };
        const t = xr();
 ...
 // Failure will be handled by AsyncQueue
                                S("AsyncQueue", "Operation failed with retryable error: " + t);
            }
            this.fc.length > 0 && 
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = mo.createAndSchedule(this, t, e, n, (t => this.Ac(t)));
 ...
 */ function Iu(e, n) {
    ...
    if (s.isInitialized()) throw new P(R.FAILED_PRECONDITION, "Firestore can only be initialized once per app.");
    if (void 0 !== n.cacheSizeBytes && -1 !== n.cacheSizeBytes && n.cacheSizeBytes < 1048576) throw new P(R.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    return s.initialize({
        options: n
    });
}
...
function Pu(t) {
    ...
    const n = t._freezeSettings(), s = function(t, e, n, s) {
        return new Wc(t, e, n, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new bc(t._credentials, t._queue, s);
}
 ...
 */ function Vu(t, e, n) {
    ...
    return t.asyncQueue.enqueue((async () => {
        try {
            await vc(t, n), await Vc(t, e), s.resolve();
        } catch (t) {
            if (!
            /**
 ...
 */
            function(t) {
                if ("FirebaseError" === t.name) return t.code === R.FAILED_PRECONDITION || t.code === R.UNIMPLEMENTED;
...
function Su(t) {
    if (t._initialized && !t._terminated) throw new P(R.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
    const e = new Ps;
 ...
 */ function Du(t) {
    return function(t) {
        const e = new Ps;
        return t.asyncQueue.enqueueAndForget((async () => zo(await kc(t), e))), e.promise;
    }(Ru(t = iu(t, Tu)));
}
 ...
 */ function Ou(t, e) {
    return jc(Ru(t = iu(t, Tu)), e).then((e => e ? new hu(t, null, e.query) : null));
}

function $u(t) {
    if (t._initialized || t._terminated) throw new P(R.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
...
class Mu {
     ...
     */
    constructor(...t) {
        for (let e = 0; e < t.length; ++e) if (0 === t[e].length) throw new P(R.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
 ...
 */ class Lu {
     ...
     */    static fromBase64String(t) {
        try {
            return new Lu(Y.fromBase64String(t));
        } catch (t) {
            throw new P(R.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + t);
        }
    }
    /**
     ...
     */    static fromUint8Array(t) {
        return new Lu(Y.fromUint8Array(t));
    }
    /**
...
/** A "context" object passed around while parsing user data. */ class Wu {
    ...
    $c(t) {
        return fa(t, this.settings.methodName, this.settings.Mc || !1, this.path, this.settings.Fc);
    }
    ...
    xc(t) {
        ...
        if (ju(this.Sc) && Uu.test(t)) throw this.$c('Document fields cannot begin and end with "__"');
    }
}
...
/** Parse document data from a set() call. */ function Hu(t, e, n, s, i, r = {}) {
    ...
    ua("Data must be an object, but it was:", o, s);
    const c = oa(s, o);
    let u, a;
    if (r.merge) u = new J(o.fieldMask), a = o.fieldTransforms; else if (r.mergeFields) {
        ...
        for (const s of r.mergeFields) {
            const i = aa(e, s, n);
            if (!o.contains(i)) throw new P(R.INVALID_ARGUMENT, `Field '${i}' is specified in your field mask but missing from your input data.`);
            da(t, i) || t.push(i);
        }
...
class Zu extends Bu {
    ...
    _toFieldTransform(t) {
        const e = Yu(this, t, 
        /*array=*/ !0), n = this.Bc.map((t => ra(t, e))), s = new ye(n);
...
class ta extends Bu {
    ...
    _toFieldTransform(t) {
        const e = Yu(this, t, 
        /*array=*/ !0), n = this.Bc.map((t => ra(t, e))), s = new Ee(n);
        return new Pe(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
/** Parse update data from an update() call. */ function na(t, e, n, s) {
    const i = t.Lc(1 /* Update */ , e, n);
    ua("Data must be an object, but it was:", i, s);
    const r = [], o = It.empty();
    Q(s, ((t, s) => {
        const c = la(e, t, n);
...
/** Parse update data from a list of field/value arguments. */ function sa(t, e, n, s, i, r) {
    const o = t.Lc(1 /* Update */ , e, n), c = [ aa(e, s, n) ], u = [ i ];
    if (r.length % 2 != 0) throw new P(R.INVALID_ARGUMENT, `Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);
    for (let t = 0; t < r.length; t += 2) c.push(aa(e, r[t])), u.push(r[t + 1]);
    const a = [], h = It.empty();
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (let t = c.length - 1; t >= 0; --t) if (!da(a, c[t])) {
        const e = c[t];
        let n = u[t];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
 ...
 */ function ia(t, e, n, s = !1) {
    return ra(n, t.Lc(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function ra(t, e) {
    ...
    // from firestore-exp.
    t = w(t))) return ua("Unsupported field value:", e, t), oa(t, e);
    if (t instanceof Bu) 
 ...
 */
    return function(t, e) {
        ...
        if (!ju(e.Sc)) throw e.$c(`${t._methodName}() can only be used with update() and set()`);
...
function ca(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof q || t instanceof qu || t instanceof Lu || t instanceof au || t instanceof Bu);
}
 ...
 */ function aa(t, e, n) {
    ...
    // FieldPath.
    e = w(e)) instanceof Mu) return e._internalPath;
 ...
 * evaluated.
 */ function la(t, e, n) {
    if (e.search(ha) >= 0) throw fa(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
...
function fa(t, e, n, s, i) {
    ...
    u += ")"), new P(R.INVALID_ARGUMENT, c + t + u);
}

/** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */ function da(t, e) {
 ...
 */ class wa {
     ...
     */    data() {
        if (this._document) {
            if (this._converter) {
                ...
                const t = new _a(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    get(t) {
        if (this._document) {
            const e = this._document.data.field(ma("DocumentSnapshot.get", t));
 ...
 */ class ya extends wa {
     ...
     */    data(t = {}) {
        if (this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                const e = new pa(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    get(t, e = {}) {
        if (this._document) {
            const n = this._document.data.field(ma("DocumentSnapshot.get", t));
 ...
 */ class Ea {
     ...
     */    forEach(t, e) {
        this._snapshot.docs.forEach((n => {
            t.call(e, new pa(this._firestore, this._userDataWriter, n.key, n, new ga(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query._converter));
        }));
    }
    /**
     ...
     */    docChanges(t = {}) {
        ...
        if (e && this._snapshot.excludesMetadataChanges) throw new P(R.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((s => {
                    const i = new pa(t._firestore, t._userDataWriter, s.doc.key, s.doc, new ga(t._snapshot.mutatedKeys.has(s.doc.key), t._snapshot.fromCache), t.query._converter);
                    return e = s.doc, {
                        type: "added",
                        doc: i,
                        oldIndex: -1,
            ...
            }
            {
                ...
                return t._snapshot.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new pa(t._firestore, t._userDataWriter, e.doc.key, e.doc, new ga(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query._converter);
                    let i = -1, r = -1;
 ...
 * limitations under the License.
 */ function Aa(t) {
    if (Yt(t) && 0 === t.explicitOrderBy.length) throw new P(R.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
class ba extends Ra {
    ...
    _apply(t) {
        const e = zu(t.firestore), n = function(t, e, n, s, i, r, o) {
            let c;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === r || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === r) throw new P(R.INVALID_ARGUMENT, `Invalid Query. You can't perform '${r}' queries on FieldPath.documentId().`);
                if ("in" /* IN */ === r || "not-in" /* NOT_IN */ === r) {
                    qa(o, r);
                    const e = [];
                    for (const n of o) e.push(Ba(s, t, n));
                    c = {
                        arrayValue: {
                            values: e
                        }
            ...
            } else "in" /* IN */ !== r && "not-in" /* NOT_IN */ !== r && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== r || qa(o, r), 
            c = ia(n, e, o, 
 ...
 */
                ...
                throw n === e.op ? new P(R.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new P(R.INVALID_ARGUMENT, `Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`);
            }(t, u), u;
...
class Da extends Ra {
    ...
    _apply(t) {
        return new hu(t.firestore, t._converter, se(t._query, this.Wc, this.Gc));
    }
}
 ...
 * @returns The created `Query`.
 */ function Ca(t) {
    return ru("limit", t), new Da("limit", t, "F" /* First */);
}
 ...
 * @returns The created `Query`.
 */ function Na(t) {
    return ru("limitToLast", t), new Da("limitToLast", t, "L" /* Last */);
}
...
class xa extends Ra {
    ...
    _apply(t) {
        const e = La(t, this.type, this.zc, this.Hc);
        return new hu(t.firestore, t._converter, function(t, e) {
...
function Ma(...t) {
    return new $a("endBefore", t, /*before=*/ !0);
}

function Fa(...t) {
    return new $a("endAt", t, /*before=*/ !1);
}

/** Helper function to create a bound from a document or fields */ function La(t, e, n, s) {
    if (n[0] = w(n[0]), n[0] instanceof wa) return function(t, e, n, s, i) {
        if (!s) throw new P(R.NOT_FOUND, `Can't use a DocumentSnapshot that doesn't exist for ${n}().`);
        const r = [];
        ...
        // results.
            ...
            if (nt(t)) throw new P(R.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
                const t = n.field.canonicalString();
                throw new P(R.INVALID_ARGUMENT, `Invalid query. You are trying to start or end a query using a document for which the field '${t}' (used as the orderBy) does not exist.`);
            }
            r.push(t);
        }
        return new qt(r, i);
 ...
 */ (t._query, t.firestore._databaseId, e, n[0]._document, s);
    {
        ...
        return function(t, e, n, s, i, r) {
            ...
            if (i.length > o.length) throw new P(R.INVALID_ARGUMENT, `Too many arguments provided to ${s}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
            const c = [];
            for (let r = 0; r < i.length; r++) {
                const u = i[r];
                if (o[r].field.isKeyField()) {
                    if ("string" != typeof u) throw new P(R.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${s}(), but got a ${typeof u}`);
                    if (!te(t) && -1 !== u.indexOf("/")) throw new P(R.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${u}' contains a slash.`);
                    const n = t.path.child(G.fromString(u));
                    if (!ut.isDocumentKey(n)) throw new P(R.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                    const i = new ut(n);
                    c.push(mt(e, i));
                } else {
                    const t = ia(n, s, u);
...
function Ba(t, e, n) {
    if ("string" == typeof (n = w(n))) {
        ...
        if (!te(e) && -1 !== n.indexOf("/")) throw new P(R.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        const s = e.path.child(G.fromString(n));
        if (!ut.isDocumentKey(s)) throw new P(R.INVALID_ARGUMENT, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
        return mt(t, new ut(s));
    }
    if (n instanceof au) return mt(t, n._key);
    throw new P(R.INVALID_ARGUMENT, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${su(n)}.`);
}
 ...
 */ class Ka {
    ...
    convertDocumentKey(t, e) {
        const n = G.fromString(t);
        k(es(n));
        const s = new Gc(n.get(1), n.get(3)), i = new ut(n.popFirst(5));
        return s.isEqual(e) || 
        // TODO(b/64130202): Somehow support foreign references.
        D(`Document ${i} contains a document reference within a different database (${s.projectId}/${s.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`), 
        i;
    }
}
 ...
 */ class Wa {
    ...
    set(t, e, n) {
        ...
        const s = Ga(t, this._firestore), i = Qa(s._converter, e, n), r = Hu(this._dataReader, "WriteBatch.set", s._key, i, null !== s._converter, n);
        return this._mutations.push(r.toMutation(s._key, Ve.none())), this;
    }
    update(t, e, n, ...s) {
        this._verifyNotCommitted();
        const i = Ga(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let r;
        return r = "string" == typeof (e = w(e)) || e instanceof Mu ? sa(this._dataReader, "WriteBatch.update", i._key, e, n, s) : na(this._dataReader, "WriteBatch.update", i._key, e), 
    ...
    _verifyNotCommitted() {
        if (this._committed) throw new P(R.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}

function Ga(t, e) {
    if ((t = w(t)).firestore !== e) throw new P(R.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
...
function za(t) {
    ...
    return Lc(Ru(e), t._key).then((n => uh(e, t, n)));
}
 ...
 */ function Ja(t) {
    t = iu(t, au);
    const e = iu(t.firestore, Tu), n = Ru(e), s = new Ha(e);
    return Fc(n, t._key).then((n => new ya(e, s, t._key, n, new ga(null !== n && n.hasLocalMutations, 
 ...
 */ function Xa(t) {
    t = iu(t, hu);
    const e = iu(t.firestore, Tu), n = Ru(e), s = new Ha(e);
    return Aa(t._query), qc(n, t._query).then((n => new Ea(e, s, t, n)));
}
 ...
 */ function Za(t) {
    t = iu(t, hu);
    const e = iu(t.firestore, Tu), n = Ru(e), s = new Ha(e);
    return Bc(n, t._query).then((n => new Ea(e, s, t, n)));
}
 ...
 */ function th(t) {
    ...
    return qc(n, t._query, {
        source: "server"
    }).then((n => new Ea(e, s, t, n)));
}

function eh(t, e, n) {
    t = iu(t, au);
    const s = iu(t.firestore, Tu), i = Qa(t._converter, e, n);
...
function nh(t, e, n, ...s) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = w(e)) || e instanceof Mu ? sa(r, "updateDoc", t._key, e, n, s) : na(r, "updateDoc", t._key, e);
 ...
 */ function ih(t, e) {
    const n = iu(t.firestore, Tu), s = wu(t), i = Qa(t._converter, e);
...
function rh(t, ...e) {
    ...
    return function(t, e, n, s) {
        ...
        return t.asyncQueue.enqueueAndForget((async () => Ao(await Oc(t), r))), () => {
            i.Wo(), t.asyncQueue.enqueueAndForget((async () => Ro(await Oc(t), r)));
        };
    }(Ru(a), h, c, u);
}

function oh(t, e) {
    return Uc(Ru(t = iu(t, Tu)), yu(e) ? e : {
        next: e
    });
}
 ...
 */ function ch(t, e) {
    return function(t, e) {
        const n = new Ps;
        return t.asyncQueue.enqueueAndForget((async () => Uo(await kc(t), e, n))), n.promise;
    }(Ru(t), e);
}
 ...
 */ function uh(t, e, n) {
    const s = n.docs.get(e._key), i = new Ha(t);
 ...
 */ class ah extends class {
     ...
     */    get(t) {
        const e = Ga(t, this._firestore), n = new ja(this._firestore);
        return this._transaction.lookup([ e._key ]).then((t => {
            if (!t || 1 !== t.length) return x();
            const s = t[0];
            if (s.isFoundDocument()) return new wa(this._firestore, n, s.key, s, e._converter);
            if (s.isNoDocument()) return new wa(this._firestore, n, e._key, null, e._converter);
            throw x();
        }));
    }
    set(t, e, n) {
        const s = Ga(t, this._firestore), i = Qa(s._converter, e, n), r = Hu(this._dataReader, "Transaction.set", s._key, i, null !== s._converter, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = w(e)) || e instanceof Mu ? sa(this._dataReader, "Transaction.update", i._key, e, n, s) : na(this._dataReader, "Transaction.update", i._key, e), 
     ...
     * @returns A `DocumentSnapshot` with the read data.
     */    get(t) {
        const e = Ga(t, this._firestore), n = new Ha(this._firestore);
 ...
 * writes.
 */ function mh(t) {
    return Ru(t = iu(t, Tu)), new Wa(t, (e => ch(t, e)));
}
...
export { Ka as AbstractUserDataWriter, Lu as Bytes, Eu as CACHE_SIZE_UNLIMITED, lu as CollectionReference, au as DocumentReference, ya as DocumentSnapshot, Mu as FieldPath, Bu as FieldValue, Tu as FirebaseFirestore, P as FirestoreError, qu as GeoPoint, pu as LoadBundleTask, hu as Query, Ra as QueryConstraint, pa as QueryDocumentSnapshot, Ea as QuerySnapshot, ga as SnapshotMetadata, q as Timestamp, ah as Transaction, Wa as WriteBatch, ih as addDoc, wh as arrayRemove, dh as arrayUnion, Su as clearIndexedDbPersistence, fu as collection, du as collectionGroup, sh as deleteDoc, lh as deleteField, Nu as disableNetwork, wu as doc, Fu as documentId, bu as enableIndexedDbPersistence, vu as enableMultiTabIndexedDbPersistence, Cu as enableNetwork, Fa as endAt, Ma as endBefore, Ru as ensureFirestoreConfigured, ch as executeWrite, za as getDoc, Ja as getDocFromCache, Ya as getDocFromServer, Xa as getDocs, Za as getDocsFromCache, th as getDocsFromServer, Au as getFirestore, _h as increment, Iu as initializeFirestore, Ca as limit, Na as limitToLast, ku as loadBundle, Ou as namedQuery, rh as onSnapshot, oh as onSnapshotsInSync, Sa as orderBy, Pa as query, mu as queryEqual, _u as refEqual, hh as runTransaction, fh as serverTimestamp, eh as setDoc, V as setLogLevel, Ia as snapshotEqual, Oa as startAfter, ka as startAt, xu as terminate, nh as updateDoc, uu as useFirestoreEmulator, Du as waitForPendingWrites, va as where, mh as writeBatch };
