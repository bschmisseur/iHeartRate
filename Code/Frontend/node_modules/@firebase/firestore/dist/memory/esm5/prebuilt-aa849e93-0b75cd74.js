import { isMobileCordova as t, isReactNative as e, isElectron as n, isIE as r, isUWP as i, isBrowserExtension as o, getModularInstance as s } from "@firebase/util";

import { Logger as u, LogLevel as a } from "@firebase/logger";

import { XhrIo as c, EventType as h, ErrorCode as l, createWebChannelTransport as f, getStatEventTarget as d, WebChannel as p, Event as y, Stat as v } from "@firebase/webchannel-wrapper";
...
var E = {
    ...
    return m(e, t), e;
}(Error), I = new u("@firebase/firestore");
 ...
 */ function N(t) {
    ...
    if (I.logLevel <= a.DEBUG) {
        var r = e.map(R);
        I.debug.apply(I, b([ "Firestore (8.3.2): " + t ], r));
    }
}
...
function S(t) {
    ...
    if (I.logLevel <= a.ERROR) {
        var r = e.map(R);
        I.error.apply(I, b([ "Firestore (8.3.2): " + t ], r));
    }
}
...
function D(t) {
    ...
    if (I.logLevel <= a.WARN) {
        var r = e.map(R);
        I.warn.apply(I, b([ "Firestore (8.3.2): " + t ], r));
    }
}
 ...
 */ var P = /** @class */ function() {
    ...
    return t.u = function() {
        ...
        ; n.length < 20; ) for (var r = O(40), i = 0; i < r.length; ++i) 
 ...
 */ var j = /** @class */ function() {
    ...
    return m(e, t), e.prototype.construct = function(t, n, r) {
        return new e(t, n, r);
...
}(j), K = /^[_a-zA-Z][_a-zA-Z0-9]*$/, Q = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return m(e, t), e.prototype.construct = function(t, n, r) {
 ...
 */ function tt(t) {
    var e = Y(t.mapValue.fields.__local_write_time__.timestampValue);
    return new F(e.seconds, e.nanos);
}
...
/** Extracts the backend's type order for the provided value. */ function it(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? $(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : k();
}
    ...
    switch (n) {
      ...
      case 3 /* TimestampValue */ :
        return function(t, e) {
            ...
            var n = Y(t.timestampValue), r = Y(e.timestampValue);
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            ...
            if ("doubleValue" in t && "doubleValue" in e) {
                ...
                return n === r ? nt(n) === nt(r) : isNaN(n) && isNaN(r);
            }
            return !1;
        }(t, e);

      case 9 /* ArrayValue */ :
        return M(t.arrayValue.values || [], e.arrayValue.values || [], ot);
...
function ut(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = V(X(t.latitude), X(e.latitude));
            return 0 !== n ? n : V(X(t.longitude), X(e.longitude));
...
function at(t, e) {
    ...
    var n = Y(t), r = Y(e), i = V(n.seconds, r.seconds);
 ...
 */ var mt = /** @class */ function() {
    ...
    t.prototype.applyOverlay = function(e, n) {
        var r = this, i = !1, o = t.extractNestedValue(this.partialValue, e), s = vt(o) ? // If there is already data at the current path, base our
    ...
    t.prototype.buildProto = function() {
        var t = this.applyOverlay(Q.emptyPath(), this.overlayMap);
        ...
        for (var n = t, r = 0; r < e.length - 1; ++r) {
            ...
            if (!vt(n = n.mapValue.fields[e.get(r)])) return null;
        }
...
var wt = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , U.min(), mt.empty(), 0 /* SYNCED */);
    }, 
    /**
...
function Et(t) {
    ...
    if (null === e.h) {
        ...
        })).join(","), et(e.limit) || (n += "|l:", n += e.limit), e.startAt && (n += "|lb:", 
...
function Tt(t, e) {
    ...
    for (var n = 0; n < t.orderBy.length; n++) if (!Ft(t.orderBy[n], e.orderBy[n])) return !1;
...
var At = /** @class */ function(t) {
     ...
     */    return m(e, t), e.create = function(t, n, r) {
        return t.isKeyField() ? "in" /* IN */ === n || "not-in" /* NOT_IN */ === n ? this.l(t, n, r) : new Nt(t, n, r) : "array-contains" /* ARRAY_CONTAINS */ === n ? new kt(t, r) : "in" /* IN */ === n ? new Ct(t, r) : "not-in" /* NOT_IN */ === n ? new Lt(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === n ? new Ot(t, r) : new e(t, n, r);
    }, e.l = function(t, e, n) {
        return "in" /* IN */ === e ? new St(t, n) : new Dt(t, n);
    }, e.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.m(ut(e, this.value)) : null !== e && it(this.value) === it(e) && this.m(ut(e, this.value));
...
var Nt = /** @class */ function(t) {
    function e(e, n, r) {
        var i = this;
        return (i = t.call(this, e, n, r) || this).key = rt.fromName(r.referenceValue), 
        i;
    }
 ...
 */ function Ut(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.isKeyField() ? rt.comparator(rt.fromName(s.referenceValue), n.key) : ut(s, n.data.field(o.field)), 
...
/** Creates a new Query for a query that matches all documents at `path` */ function Bt(t) {
    return new qt(t);
}
 ...
 */ function Wt(t) {
    ...
    if (null === e.p) {
        ...
        n.isKeyField() || e.p.push(new Mt(n)), e.p.push(new Mt(Q.keyField(), "asc" /* ASCENDING */)); else {
 ...
 */ function Ht(t) {
    var e = L(t);
    if (!e.T) if ("F" /* First */ === e.limitType) e.T = _t(e.path, e.collectionGroup, Wt(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = Wt(e); r < i.length; r++) {
        ...
        // Now return as a LimitType.First query.
                e.T = _t(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.T;
}
...
function Xt(t, e) {
    return Tt(Ht(t), Ht(e)) && t.limitType === e.limitType;
}
...
function $t(t) {
    return "Query(target=" + function(t) {
        ...
        et(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return function(t) {
                return t.field.canonicalString() + " (" + t.dir + ")";
            }(t);
        })).join(", ") + "]"), t.startAt && (e += ", startAt: " + Vt(t.startAt)), t.endAt && (e += ", endAt: " + Vt(t.endAt)), 
        "Target(" + e + ")";
    }(Ht(t)) + "; limitType=" + t.limitType + ")";
}

/** Returns whether `doc` matches the constraints of `query`. */ function Zt(t, e) {
    return e.isFoundDocument() && function(t, e) {
        ...
        return !(t.startAt && !Ut(t.startAt, Wt(t), e)) && (!t.endAt || !Ut(t.endAt, Wt(t), e));
    }(t, e);
}

function te(t) {
    return function(e, n) {
        for (var r = !1, i = 0, o = Wt(t); i < o.length; i++) {
            var s = o[i], u = ee(s, e, n);
            if (0 !== u) return u;
...
function ee(t, e, n) {
    var r = t.field.isKeyField() ? rt.comparator(e.key, n.key) : function(t, e, n) {
        var r = e.data.field(t), i = n.data.field(t);
        return null !== r && null !== i ? ut(r, i) : k();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return r;
 ...
 */ function se(t, e, n) {
    ...
    }(n, e) : t instanceof he ? le(t, e) : t instanceof fe ? de(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = ae(t, e), r = ye(n) + ye(t.A);
        return ft(n) && ft(t.A) ? re(r) : ne(t.R, r);
    }(t, e);
}
 ...
 */ function ue(t, e, n) {
    ...
    // applications.
    return t instanceof he ? le(t, e) : t instanceof fe ? de(t, e) : n;
}
 ...
 */ function ae(t, e) {
    return t instanceof pe ? ft(n = e) || function(t) {
...
/** Transforms a value into a server-generated timestamp. */ var ce = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return m(e, t), e;
}(oe), he = /** @class */ function(t) {
    function e(e) {
        var n = this;
...
/** Transforms an array value via a union operation. */ function le(t, e) {
...
/** Transforms an array value via a remove operation. */ var fe = /** @class */ function(t) {
    function e(e) {
        var n = this;
        return (n = t.call(this) || this).elements = e, n;
    }
 ...
 */ function Ee(t, e, n) {
    t instanceof Se ? function(t, e, n) {
        // Unlike applySetMutationToLocalView, if we're applying a mutation to a
        // remote document the server has accepted the mutation so the precondition
        // must have held.
        var r = t.value.clone(), i = ke(t.fieldTransforms, e, n.transformResults);
        ...
        if (be(t.precondition, e)) {
            var r = ke(t.fieldTransforms, e, n.transformResults), i = e.data;
 ...
 */ function Te(t, e, n) {
    t instanceof Se ? function(t, e, n) {
        if (be(t.precondition, e)) {
            var r = t.value.clone(), i = Ce(t.fieldTransforms, n, e);
            r.setAll(i), e.convertToFoundDocument(Ne(e), r).setHasLocalMutations();
        }
    }(t, e, n) : t instanceof De ? function(t, e, n) {
        if (be(t.precondition, e)) {
            var r = Ce(t.fieldTransforms, n, e), i = e.data;
            i.setAll(Re(t)), i.setAll(r), e.convertToFoundDocument(Ne(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        be(t.precondition, e) && 
 ...
 */ function Ie(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        var o = i[r], s = e.data.field(o.field), u = ae(o.transform, s || null);
        null != u && (null == n && (n = mt.empty()), n.set(o.field, u));
    }
    return n || null;
}
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && M(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof he && e instanceof he || t instanceof fe && e instanceof fe ? M(t.elements, e.elements, ot) : t instanceof pe && e instanceof pe ? ot(t.A, e.A) : t instanceof ce && e instanceof ce;
 ...
 */ function Ce(t, e, n) {
    for (var r = new Map, i = 0, o = t; i < o.length; i++) {
        ...
        r.set(s.field, se(u, a, e));
    }
    return r;
}

/** A mutation that deletes the document at the given key. */ var Le, Oe, Pe = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
 ...
 */ function Ue(t) {
    ...
    return S("GRPC error has no .code"), E.UNKNOWN;
    switch (t) {
      case Le.OK:
        return E.OK;
 ...
 *     Code.UNKNOWN.
 */ (Oe = Le || (Le = {}))[Oe.OK = 0] = "OK", Oe[Oe.CANCELLED = 1] = "CANCELLED", 
Oe[Oe.UNKNOWN = 2] = "UNKNOWN", Oe[Oe.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", 
Oe[Oe.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", Oe[Oe.NOT_FOUND = 5] = "NOT_FOUND", 
Oe[Oe.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", Oe[Oe.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", 
Oe[Oe.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", Oe[Oe.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", 
Oe[Oe.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", Oe[Oe.ABORTED = 10] = "ABORTED", 
Oe[Oe.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", Oe[Oe.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", 
Oe[Oe.INTERNAL = 13] = "INTERNAL", Oe[Oe.UNAVAILABLE = 14] = "UNAVAILABLE", Oe[Oe.DATA_LOSS = 15] = "DATA_LOSS";
...
var xe = /** @class */ function() {
    function t(t, e) {
        this.comparator = t, this.root = e || Be.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
        return t.prototype.insert = function(e, n) {
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, Be.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, Be.BLACK, null, null));
    }, 
...
}(), Ke = new xe(rt.comparator);

function Qe() {
    return Ke;
}

var ze = new xe(rt.comparator);

function We() {
    return ze;
}

var He = new xe(rt.comparator);

function Ye() {
    return He;
}

var Xe = new je(rt.comparator);
 ...
 */ var tn = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, en.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(U.min(), r, Ze(), Qe(), Je());
    }, t;
}(), en = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(W.EMPTY_BYTE_STRING, n, Je(), Je(), Je());
    }, t;
}(), nn = function(
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = W.EMPTY_BYTE_STRING), void 0 === r && (r = null), this.state = t, 
    ...
    function t() {
        ...
        this.C = W.EMPTY_BYTE_STRING, this.N = !1, 
        /**
    ...
    t.prototype.rt = function(t) {
        ...
        if (r) {
            ...
            if (It(i)) if (0 === n) {
                ...
                // queries.
                var o = new rt(i.path);
                this.tt(e, o, wt.newNoDocument(o, U.min()));
            } else C(1 === n); else this.ct(e) !== n && (
    ...
    t.prototype.ut = function(t) {
        ...
        this.G.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && It(o.target)) {
                    ...
                    var s = new rt(o.target.path);
                    null !== e.H.get(s) || e.at(i, s) || e.tt(i, s, wt.newNoDocument(s, t));
                }
                r.O && (n.set(i, r.M()), r.L());
            }
        }));
        ...
        var i = new tn(t, n, this.Y, this.H, r);
        return this.H = Qe(), this.J = an(), this.Y = new je(V), i;
    }, 
    /**
    ...
    t.prototype.U = function(t) {
        ...
        var e = this.G.get(t);
        return e || (e = new sn, this.G.set(t, e)), e;
    }, t.prototype.ht = function(t) {
        var e = this.J.get(t);
        return e || (e = new je(V), this.J = this.J.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.it = function(t) {
        var e = this;
        this.G.set(t, new sn), this.W.getRemoteKeysForTarget(t).forEach((function(n) {
 ...
 */ function yn(t, e) {
    return dn(t, e.toTimestamp());
}

function vn(t) {
    return C(!!t), U.fromTimestamp(function(t) {
        var e = Y(t);
        return new F(e.seconds, e.nanos);
    }(t));
}
...
function gn(t) {
    var e = G.fromString(t);
    return C(xn(e)), e;
}

function wn(t, e) {
    return mn(t.databaseId, e.path);
}
...
function _n(t, e) {
    return mn(t.databaseId, e);
}

function En(t) {
    return new G([ "projects", t.databaseId.projectId, "databases", t.databaseId.database ]).canonicalString();
}
...
function An(t, e) {
    ...
    if (e instanceof Se) n = {
        update: In(t, e.key, e.value)
    }; else if (e instanceof Pe) n = {
        delete: wn(t, e.key)
    }; else if (e instanceof De) n = {
        update: In(t, e.key, e.data),
        updateMask: Un(e.fieldMask)
    }; else {
        if (!(e instanceof Ve)) return k();
        n = {
            verify: wn(t, e.key)
        };
    }
...
function Sn(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = _n(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = _n(t, r.popLast()), n.structuredQuery.from = [ {
    ...
    return null !== s && (n.structuredQuery.limit = s), e.startAt && (n.structuredQuery.startAt = kn(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = kn(e.endAt)), n;
}
...
function Dn(t) {
    var e = function(t) {
        ...
        // in the local target cache.
                return 4 === e.length ? G.emptyPath() : Tn(e);
    ...
    n.limit && (a = function(t) {
        var e;
        return et(e = "object" == typeof t ? t.value : t) ? null : e;
    }(n.limit));
    var c = null;
    n.startAt && (c = Cn(n.startAt));
    var h = null;
    return n.endAt && (h = Cn(n.endAt)), function(t, e, n, r, i, o, s, u) {
        return new qt(t, e, n, r, i, o, s, u);
    }(e, i, u, s, a, "F" /* First */ , c, h);
}

function Rn(t) {
    return t ? void 0 !== t.unaryFilter ? [ Fn(t) ] : void 0 !== t.fieldFilter ? [ Mn(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return Rn(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : k() : [];
...
function Mn(t) {
    return At.create(Vn(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function Fn(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        var e = Vn(t.unaryFilter.field);
        return At.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        var n = Vn(t.unaryFilter.field);
        return At.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        var r = Vn(t.unaryFilter.field);
        return At.create(r, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        var i = Vn(t.unaryFilter.field);
 ...
 * on persistence.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Gn(t) {
 ...
 */ var Kn = /** @class */ function() {
    ...
    return t.prototype.applyToRemoteDocument = function(t, e) {
        for (var n = e.mutationResults, r = 0; r < this.mutations.length; r++) {
            ...
            i.key.isEqual(t.key) && Ee(i, t, n[r]);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalView = function(t) {
        ...
        for (var e = 0, n = this.baseMutations; e < n.length; e++) {
            (o = n[e]).key.isEqual(t.key) && Te(o, t, this.localWriteTime);
        }
        // Second, apply all user-provided mutations.
                for (var r = 0, i = this.mutations; r < i.length; r++) {
            var o;
            (o = i[r]).key.isEqual(t.key) && Te(o, t, this.localWriteTime);
        }
    }, 
    /**
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = Ye(), o = e.mutations, s = 0; s < o.length; s++) i = i.insert(o[s].key, r[s].version);
     ...
     * time from which the server should resume sending results.
     */ , s) {
        void 0 === i && (i = U.min()), void 0 === o && (o = U.min()), void 0 === s && (s = W.EMPTY_BYTE_STRING), 
 ...
 */ var Yn = /** @class */ function() {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        return this.Bt.add(e), jn.resolve();
    }, t.prototype.getCollectionParents = function(t, e) {
        return jn.resolve(this.Bt.getEntries(e));
    }, t;
}(), Xn = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new je(G.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new je(G.comparator)).toArray();
    }, t;
}(), Jn = /** @class */ function() {
    function t(t) {
        this.Ht = t;
 ...
 */ var Zn = /** @class */ function() {
    ...
    function t() {
        ...
        this.changes = new Zn((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
    ...
    t.prototype.getEntry = function(t, e) {
        ...
        return void 0 !== n ? jn.resolve(n.document) : this.getFromCache(t, e);
    }, 
    /**
 ...
 */
        ...
        return this.mn(t, new rt(e)).next((function(t) {
            var e = We();
            return t.isFoundDocument() && (e = e.insert(t.key, t)), e;
        }));
    }, t.prototype.In = function(t, e, n) {
        var r = this, i = e.collectionGroup, o = We();
        return this.Ut.getCollectionParents(t, i).next((function(s) {
            return jn.forEach(s, (function(s) {
                var u = function(t, e) {
                    return new qt(e, 
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Rn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    h = wt.newInvalidDocument(c), r = r.insert(c, h)), Te(a, h, o.localWriteTime), h.isFoundDocument() || (r = r.remove(c));
                }
            }));
        })).next((function() {
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = i.Cn(e, o);
            return (jt(e) || Gt(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (A() <= a.DEBUG && N("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), $t(e)), 
    ...
    t.prototype.Nn = function(t, e, n, r) {
        ...
        return A() <= a.DEBUG && N("QueryEngine", "Using full collection scan to execute query:", $t(e)), 
    ...
    t, e, n, r) {
        ...
        this.qe = t.getTargetCache(), this.Mn = new nr(this.$n, this._n, this.persistence.getIndexManager()), 
              ...
              case 0:
                return n = L(t), r = n._n, i = n.Mn, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    return n._n.getAllMutationBatches(t).next((function(s) {
                        ...
                        // MutationQueue.
                        i = new nr(n.$n, r, n.persistence.getIndexManager()), r.getAllMutationBatches(t);
                    })).next((function(e) {
 ...
 */ function ur(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        ...
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), s = jn.resolve();
            return o.forEach((function(t) {
                s = s.next((function() {
                    return r.getEntry(e, t);
                })).next((function(e) {
                    var o = n.docVersions.get(t);
                    C(null !== o), e.version.compareTo(o) < 0 && (i.applyToRemoteDocument(e, n), e.isValidDocument() && 
 ...
 */ function cr(t, e) {
     ...
     */
                    function(t, e, n) {
                        ...
                        return C(e.resumeToken.approximateByteSize() > 0), 0 === t.resumeToken.approximateByteSize() || (
        ...
        s.push(hr(t, o, e.documentUpdates, r, void 0).next((function(t) {
            u = t;
        }))), !r.isEqual(U.min())) {
        ...
        return jn.waitFor(s).next((function() {
            return o.apply(t);
        })).next((function() {
            return n.Mn.En(t, u);
        })).next((function() {
 ...
 */ function fr(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        ...
        return n.qe.getTargetData(t, e).next((function(i) {
            ...
            r = i, jn.resolve(r)) : n.qe.allocateTargetId(t).next((function(i) {
                return r = new zn(e, i, 0 /* Listen */ , t.currentSequenceNumber), n.qe.addTargetData(t, r).next((function() {
                    return r;
                }));
            }));
        }));
 ...
 */ function pr(t, e, n) {
    var r = L(t), i = U.min(), o = Je();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = L(t), i = r.kn.get(n);
            return void 0 !== i ? jn.resolve(r.Fn.get(i)) : r.qe.getTargetData(e, n);
        }(r, t, Ht(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r.qe.getMatchingKeysForTargetId(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r.xn.getDocumentsMatchingQuery(t, e, n ? i : U.min(), n ? o : Je());
        })).next((function(t) {
            return {
                documents: t,
                Bn: o
 ...
 */ function yr(t, e, n, r) {
    return g(this, void 0, void 0, (function() {
        ...
        return w(this, (function(p) {
            switch (p.label) {
              case 0:
                for (i = L(t), o = Je(), s = Qe(), u = Ye(), a = 0, c = n; a < c.length; a++) h = c[a], 
                ...
                return f = i.$n.newChangeBuffer({
                    trackRemovals: !0
                }), [ 4 /*yield*/ , fr(i, function(t) {
                    // It is OK that the path used for the query is not valid, because this will
                    // not be read and queried.
                    return Ht(Bt(G.fromString("__bundle__/docs/" + t)));
                }(r)) ];
              ...
              case 1:
                ...
                return d = p.sent(), [ 2 /*return*/ , i.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return hr(t, f, s, U.min(), u).next((function(e) {
                        return f.apply(t), e;
                    })).next((function(e) {
 ...
 */ function vr(t, e, n) {
    return void 0 === n && (n = Je()), g(this, void 0, void 0, (function() {
        var r, i;
        return w(this, (function(o) {
            switch (o.label) {
              case 0:
                return [ 4 /*yield*/ , fr(t, Ht(Hn(e.bundledQuery))) ];
              ...
              case 1:
                return r = o.sent(), [ 2 /*return*/ , (i = L(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    ...
                    // Update existing target data because the query from the bundle is newer.
                                        var s = r.withResumeToken(W.EMPTY_BYTE_STRING, o);
 ...
 */ var mr = /** @class */ function() {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return jn.resolve(this.Kn.get(e));
    ...
    function t() {
        ...
        this.Wn = new je(wr.Gn), 
        // A set of outstanding references to a document sorted by target id.
        this.zn = new je(wr.Hn)
    ...
    t.prototype.Zn = function(t) {
        var e = this, n = new rt(new G([])), r = new wr(n, t), i = new wr(n, t + 1), o = [];
        ...
        var e = new rt(new G([])), n = new wr(e, t), r = new wr(e, t + 1), i = Je();
        return this.zn.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new wr(t, 0), n = this.Wn.firstAfterOrEqual(e);
    ...
    return t.Gn = function(t, e) {
        return rt.comparator(t.key, e.key) || V(t.ns, e.ns);
    }, 
    /** Compare by ID then by key */ t.Hn = function(t, e) {
        return V(t.ns, e.ns) || rt.comparator(t.key, e.key);
    }, t;
}(), br = /** @class */ function() {
    function t(t, e) {
        ...
        this.rs = new je(wr.Gn);
    }
    return t.prototype.checkEmpty = function(t) {
        return jn.resolve(0 === this._n.length);
        ...
        var o = new wr(new rt(i), 0), s = new je(V);
        ...
        var r = this.rs;
        return jn.forEach(e.mutations, (function(i) {
            var o = new wr(i.key, e.batchId);
        ...
        var n = new wr(e, 0), r = this.rs.firstAfterOrEqual(n);
        return jn.resolve(e.isEqual(r && r.key));
    }, t.prototype.performConsistencyCheck = function(t) {
        return this._n.length, jn.resolve();
    }, 
    /**
    ...
    function t(t, e) {
        ...
        this.docs = new xe(rt.comparator), 
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return jn.resolve(n ? n.document.clone() : wt.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = Qe();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.insert(t, e ? e.document.clone() : wt.newInvalidDocument(t));
        })), jn.resolve(r);
    }, t.prototype.getDocumentsMatchingQuery = function(t, e, n) {
        for (var r = Qe(), i = new rt(e.path.child("")), o = this.docs.getIteratorFrom(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.hasNext(); ) {
            var s = o.getNext(), u = s.key, a = s.value, c = a.document, h = a.readTime;
            if (!e.path.isPrefixOf(u.path)) break;
            h.compareTo(n) <= 0 || Zt(e, c) && (r = r.insert(c.key, c.clone()));
        }
        return jn.resolve(r);
    }, t.prototype.fs = function(t, e) {
        return jn.forEach(this.docs, (function(t) {
            return e(t);
        }));
    ...
    return m(e, t), e.prototype.applyChanges = function(t) {
        var e = this, n = [];
    ...
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this._s = new gr, this.targetCount = 0, this.ys = Jn.Jt();
    }
    return t.prototype.forEachTarget = function(t, e) {
        ...
        return jn.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.getHighestSequenceNumber = function(t) {
        return jn.resolve(this.ws);
    }, t.prototype.allocateTargetId = function(t) {
        return this.highestTargetId = this.ys.next(), jn.resolve(this.highestTargetId);
        ...
        return this.te(e), this.targetCount += 1, jn.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.te(e), jn.resolve();
        ...
        return this._s.Zn(e), jn.resolve();
    }, t.prototype.getMatchingKeysForTargetId = function(t, e) {
        var n = this._s.es(e);
        return jn.resolve(n);
    }, t.prototype.containsKey = function(t, e) {
        return jn.resolve(this._s.containsKey(e));
    }, t;
}(), Ir = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        ...
        this.qe = new Tr(this), this.Ut = new Yn, this.Ue = function(t, e) {
            return new _r(t, (function(t) {
                return n.referenceDelegate.ps(t);
            }));
        }(this.Ut), this.R = new Wn(e), this.Qe = new mr(this.R);
    }
    return t.prototype.start = function() {
        ...
        return e || (e = new br(this.Ut, this.referenceDelegate), this.gs[t.toKey()] = e), 
        e;
        ...
        return jn.or(Object.values(this.gs).map((function(n) {
            return function() {
    ...
    return t.bs = function(e) {
        ...
        return this.As.addReference(n, e), this.vs.delete(n.toString()), jn.resolve();
    }, t.prototype.removeReference = function(t, e, n) {
        return this.As.removeReference(n, e), this.vs.add(n.toString()), jn.resolve();
    }, t.prototype.markPotentiallyOrphaned = function(t, e) {
        return this.vs.add(e.toString()), jn.resolve();
        ...
        // Remove newly orphaned documents.
                return jn.forEach(this.vs, (function(r) {
            var i = rt.fromPath(r);
        ...
        var n = this;
        return jn.or([ function() {
            return jn.resolve(n.As.containsKey(e));
        }, function() {
...
Sr.GOOGLE_CREDENTIALS = new Sr("google-credentials-uid"), Sr.FIRST_PARTY = new Sr("first-party-uid");
...
var Dr = /** @class */ function() {
     ...
     * HTTP).
     */
    return m(u, s), u.prototype.ki = function(t, e, n, r) {
        return new Promise((function(i, o) {
            var s = new c;
            s.listenOnce(h.COMPLETE, (function() {
                try {
        ...
        var a = [ this.Di, "/", "google.firestore.v1.Firestore", "/", s, "/channel" ], c = f(), h = d(), l = {
        ...
        var m = a.join("");
        N("Connection", "Creating WebChannel: " + m, l);
        var g = c.createWebChannel(m, l), w = !1, b = !1, _ = new Or({
            Ei: function(t) {
        ...
        return I(g, p.EventType.OPEN, (function() {
            b || N("Connection", "WebChannel transport opened.");
        })), I(g, p.EventType.CLOSE, (function() {
            b || (b = !0, N("Connection", "WebChannel transport closed"), _.Vi());
        })), I(g, p.EventType.ERROR, (function(t) {
            b || (b = !0, D("Connection", "WebChannel transport errored:", t), _.Vi(new T(E.UNAVAILABLE, "The operation could not be completed")));
        })), I(g, p.EventType.MESSAGE, (function(t) {
            var e;
            if (!b) {
                var n = t.data[0];
                C(!!n);
 ...
 */
                    function(t) {
                        ...
                        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                        var e = Le[t];
                        if (void 0 !== e) return Ue(e);
                    }(o), u = i.message;
                    void 0 === s && (s = E.INTERNAL, u = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    b = !0, _.Vi(new T(s, u)), g.close();
                } else N("Connection", "WebChannel received:", n), _.Si(n);
            }
        })), I(h, y.STAT_EVENT, (function(t) {
 ...
 */ var Fr = /** @class */ function() {
    ...
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.Yi = 0, this.Xi = null, this.stream = null, this.Zi = new Fr(t, e)
        /**
            ...
            return w(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    S(e.toString()), S("Using maximum backoff delay to prevent overloading the backend."), 
    ...
    return m(e, t), e.prototype.wr = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.I ? (C(void 0 === e || "string" == typeof e), W.fromBase64String(e || "")) : (C(void 0 === e || e instanceof Uint8Array), 
                    W.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), s = (u = e.targetChange.cause) && function(t) {
                    var e = void 0 === t.code ? E.UNKNOWN : Ue(t.code);
                    return new T(e, t.message || "");
                }(u);
                n = new on(r, i, o, s || null);
            } else if ("documentChange" in e) {
                e.documentChange, (r = e.documentChange).document, r.document.name, r.document.updateTime, 
                i = bn(t, r.document.name), o = vn(r.document.updateTime);
                var u = new mt({
                    mapValue: {
                        fields: r.document.fields
                    }
                }), a = (s = wt.newFoundDocument(i, o, u), r.targetIds || []), c = r.removedTargetIds || [];
                n = new nn(a, c, s.key, s);
            } else if ("documentDelete" in e) e.documentDelete, (r = e.documentDelete).document, 
            i = bn(t, r.document), o = r.readTime ? vn(r.readTime) : U.min(), u = wt.newNoDocument(i, o), 
            s = r.removedTargetIds || [], n = new nn([], s, u.key, u); else if ("documentRemove" in e) e.documentRemove, 
            (r = e.documentRemove).document, i = bn(t, r.document), o = r.removedTargetIds || [], 
            n = new nn([], o, i, null); else {
                if (!("filter" in e)) return k();
                e.filter;
                var h = e.filter;
                h.targetId, r = h.count || 0, i = new Me(r), o = h.targetId, n = new rn(o, i);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? U.min() : e.readTime ? vn(e.readTime) : U.min();
        }(t);
    ...
    e.prototype.mr = function(t) {
        var e = {};
        e.database = En(this.R), e.addTarget = function(t, e) {
            var n, r = e.target;
            return (n = It(r) ? {
                documents: Nn(t, r)
            } : {
                query: Sn(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = pn(t, e.resumeToken) : e.snapshotVersion.compareTo(U.min()) > 0 && (
            // TODO(wuandy): Consider removing above check because it is most likely true.
            // Right now, many tests depend on this behaviour though (leaving min() out
            // of serialization).
            n.readTime = dn(t, e.snapshotVersion.toTimestamp())), n;
        }(this.R, t);
        var n = function(t, e) {
            var n = function(t, e) {
                switch (e) {
    ...
    e.prototype.yr = function(t) {
        var e = {};
        e.database = En(this.R), e.removeTarget = t, this.cr(e);
    }, e;
}(Ur), qr = /** @class */ function(t) {
    function e(e, n, r, i, o) {
        var s = this;
    ...
    return m(e, t), Object.defineProperty(e.prototype, "pr", {
        /**
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (C(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        var n = t.updateTime ? vn(t.updateTime) : vn(e);
                        ...
                        n = vn(e)), new ge(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
            }(t.writeResults, t.commitTime), n = vn(t.commitTime);
            return this.listener.Tr(n, e);
        }
        // The first response is always the handshake response
                return C(!t.writeResults || 0 === t.writeResults.length), this.gr = !0, 
        this.listener.Ir();
    }, 
    /**
    ...
    e.prototype.Ar = function() {
        ...
        var t = {};
        t.database = En(this.R), this.cr(t);
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.Vr ? (S(e), this.Vr = !1) : N("OnlineStateTracker", e);
        ...
        n.enqueueAndForget((function() {
            return g(o, void 0, void 0, (function() {
                return w(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return $r(this) ? (N("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return g(this, void 0, void 0, (function() {
                                var e;
                                return w(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = L(t)).$r.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , Qr(e) ];
 ...
 */ function Wr(t, e) {
    var n = L(t), r = di(n);
    n.Or.delete(e), r.er() && Yr(n, e), 0 === n.Or.size && (r.er() ? r.ir() : $r(n) && 
...
function Jr(t) {
    return $r(t) && !di(t).tr() && t.Or.size > 0;
}
...
function ni(t, e, n) {
    return g(this, void 0, void 0, (function() {
        ...
        return w(this, (function(s) {
            switch (s.label) {
              case 0:
                if (t.Br.set("Online" /* Online */), !(e instanceof on && 2 /* Removed */ === e.state && e.cause)) 
              ...
              case 6:
                if (e instanceof nn ? t.qr.X(e) : e instanceof rn ? t.qr.rt(e) : t.qr.et(e), n.isEqual(U.min())) return [ 3 /*break*/ , 13 ];
                s.label = 7;

              case 7:
                return s.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , ar(t.localStore) ];
                ...
                function(t, e) {
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            // state.
                            t.Or.set(e, n.withResumeToken(W.EMPTY_BYTE_STRING, n.snapshotVersion)), 
                            ...
                            var r = new zn(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                            Hr(t, r);
                        }
              ...
              case 11:
                return N("RemoteStore", "Failed to raise snapshot:", o = s.sent()), [ 4 /*yield*/ , ri(t, o) ];
        ...
        return w(this, (function(i) {
            switch (i.label) {
              case 0:
                ...
                return t.$r.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Qr(t) ];
                    ...
                    return g(r, void 0, void 0, (function() {
                        return w(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.$r.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Kr(t) ];
...
function oi(t) {
    return g(this, void 0, void 0, (function() {
        ...
        return w(this, (function(s) {
            switch (s.label) {
              case 0:
                e = L(t), n = pi(e), r = e.kr.length > 0 ? e.kr[e.kr.length - 1].batchId : -1, s.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return s.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , lr(e.localStore, r) ];
              ...
              case 4:
                return o = s.sent(), [ 4 /*yield*/ , ri(e, o) ];
...
function si(t) {
    return $r(t) && !pi(t).tr() && t.kr.length > 0;
}
...
function ci(t) {
    return g(this, void 0, void 0, (function() {
        ...
        return w(this, (function(o) {
            ...
            for (e = pi(t), n = 0, r = t.kr; n < r.length; n++) i = r[n], e.Er(i.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function hi(t, e, n) {
    return g(this, void 0, void 0, (function() {
        ...
        return w(this, (function(o) {
            switch (o.label) {
              case 0:
                return r = t.kr.shift(), i = Qn.from(r, e, n), [ 4 /*yield*/ , ii(t, (function() {
...
function li(t, e) {
    return g(this, void 0, void 0, (function() {
        return w(this, (function(n) {
            switch (n.label) {
              case 0:
                return e && pi(t).pr ? [ 4 /*yield*/ , function(t, e) {
                    return g(this, void 0, void 0, (function() {
                        var n, r;
                        return w(this, (function(i) {
                            switch (i.label) {
                              case 0:
                                return Fe(r = e.code) && r !== E.ABORTED ? (n = t.kr.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                pi(t).sr(), [ 4 /*yield*/ , ii(t, (function() {
 ...
 */ function fi(t, e) {
    return g(this, void 0, void 0, (function() {
        ...
        return w(this, (function(i) {
            switch (i.label) {
              case 0:
                return n = L(t), e ? (n.$r.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Kr(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return i.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return (r = e) ? [ 3 /*break*/ , 4 ] : (n.$r.add(2 /* IsSecondary */), [ 4 /*yield*/ , Qr(n) ]);
 ...
 */ function di(t) {
    ...
    t.Ur = function(t, e, n) {
        var r = L(t);
        return r.br(), new xr(e, r.Hi, r.credentials, r.R, n);
        ...
        return g(e, void 0, void 0, (function() {
            return w(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n ? (t.Ur.sr(), Jr(t) ? Xr(t) : t.Br.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , t.Ur.stop() ];

                  case 2:
                    e.sent(), Zr(t), e.label = 3;
    ...
    t.Qr = function(t, e, n) {
        ...
        return g(e, void 0, void 0, (function() {
            return w(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n ? (t.Qr.sr(), [ 4 /*yield*/ , oi(t) ]) : [ 3 /*break*/ , 2 ];
...
var yi = /** @class */ function() {
    function t(t, e, n, r, i) {
        ...
        this.deferred = new Bn, this.then = this.deferred.promise.then.bind(this.deferred.promise), 
 ...
 */ function vi(t, e) {
    if (S("AsyncQueue", e + ": " + t), Gn(t)) return new T(E.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var mi = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.keyedMap = We(), this.sortedSet = new xe(this.comparator)
        /**
    ...
    this.queries = new Zn((function(t) {
        return Jt(t);
    }), Xt), this.onlineState = "Unknown" /* Unknown */ , this.Gr = new Set;
};
 ...
 */ function Ei(t, e) {
    return g(this, void 0, void 0, (function() {
        ...
        return w(this, (function(c) {
            switch (c.label) {
              case 0:
                if (n = L(t), r = e.query, i = !1, (o = n.queries.get(r)) || (i = !0, o = new bi), 
                !i) return [ 3 /*break*/ , 4 ];
                c.label = 1;
              ...
              case 3:
                return u = c.sent(), a = vi(u, "Initialization of query '" + $t(e.query) + "' failed"), 
                [ 2 /*return*/ , void e.onError(a) ];

              case 4:
                return n.queries.set(r, o), o.listeners.push(e), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                e.zr(n.onlineState), o.Wr && e.Hr(o.Wr) && Ni(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ var Si = /** @class */ function() {
    ...
    return t.prototype.Hr = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new wi(t.query, t.docs, t.oldDocs, e, t.mutatedKeys, t.fromCache, t.syncStateChanged, 
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.zr = function(t) {
        ...
        t = wi.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.Yr = !0, 
        this.Jr.next(t);
    }, t;
}(), Di = /** @class */ function() {
    function t(t, 
    ...
    t.prototype.Un = function(t) {
        return t.metadata.exists ? function(t, e, n) {
            var r = bn(t, e.name), i = vn(e.updateTime), o = new mt({
                mapValue: {
                    fields: e.fields
                }
            }), s = wt.newFoundDocument(r, i, o);
            return n && s.setHasCommittedMutations(), n ? s.setHasCommittedMutations() : s;
        }(this.R, t.document, !1) : wt.newNoDocument(this.qn(t.metadata.name), this.Qn(t.metadata.readTime));
    ...
    t.prototype.complete = function() {
        return g(this, void 0, void 0, (function() {
            ...
            return w(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return [ 4 /*yield*/ , yr(this.localStore, new Ri(this.R), this.documents, this.ro.id) ];

                  case 1:
                    t = o.sent(), e = this.co(this.documents), n = 0, r = this.queries, o.label = 2;

                  case 2:
                    return n < r.length ? (i = r[n], [ 4 /*yield*/ , vr(this.localStore, i, e.get(i.name)) ]) : [ 3 /*break*/ , 5 ];
                  ...
                  case 5:
                    return [ 2 /*return*/ , (this.progress.taskState = "Success", new er(Object.assign({}, this.progress), t)) ];
                }
            }));
        }));
    }, t;
 ...
 */ var Li = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = Je(), this.lo = te(t), this.fo = new mi(this.lo);
    }
    ...
    t.prototype._o = function(t, e) {
        var n = this, r = e ? e.mo : new gi, i = e ? e.fo : this.fo, o = e ? e.mutatedKeys : this.mutatedKeys, s = i, u = !1, a = jt(this.query) && i.size === this.query.limit ? i.last() : null, c = Gt(this.query) && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal((function(t, e) {
            var h = i.get(t), l = Zt(n.query, e) ? e : null, f = !!h && n.mutatedKeys.has(h.key), d = !!l && (l.hasLocalMutations || 
            ...
            o = o.delete(t)));
        })), jt(this.query) || Gt(this.query)) for (;s.size > this.query.limit; ) {
            var h = jt(this.query) ? s.last() : s.first();
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        return this.ao = u, 0 !== o.length || a ? {
            snapshot: new wi(this.query, t.fo, i, o, t.mutatedKeys, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            To: s
        } : {
            To: s
    ...
    t.prototype.po = function(t) {
        ...
        return e.forEach((function(e) {
            t.ho.has(e) || n.push(new Oi(e));
        })), this.ho.forEach((function(t) {
            e.has(t) || n.push(new Li(t));
        })), n;
    }, 
    /**
    ...
    t.prototype.Ro = function() {
        return wi.fromInitialDocuments(this.query, this.fo, this.mutatedKeys, 0 /* Local */ === this.ao);
    }, t;
}(), Vi = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.vo = {}, this.Po = new Zn((function(t) {
            return Jt(t);
        }), Xt), this.Vo = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.Do = new xe(rt.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.Co = new Map, this.No = new gr, 
        ...
        return w(this, (function(a) {
            switch (a.label) {
              case 0:
                return n = function(t) {
                    var e = L(t);
                    return e.remoteStore.remoteSyncer.applyRemoteEvent = ji.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = ro.bind(null, e), 
                    e.remoteStore.remoteSyncer.rejectListen = Ki.bind(null, e), e.vo._r = Ii.bind(null, e.eventManager), 
                    e.vo.Mo = Ai.bind(null, e.eventManager), e;
                }(t), (o = n.Po.get(e)) ? (
              ...
              case 1:
                return [ 4 /*yield*/ , fr(n.localStore, Ht(e)) ];

              case 2:
                return s = a.sent(), u = n.sharedClientState.addLocalQueryTarget(s.targetId), r = s.targetId, 
                [ 4 /*yield*/ , xi(n, e, r, "current" === u) ];

              case 3:
                i = a.sent(), n.isPrimaryClient && zr(n.remoteStore, s), a.label = 4;
                    ...
                    return function(t, e, n, r) {
                        return g(this, void 0, void 0, (function() {
                            ...
                            return w(this, (function(u) {
                                switch (u.label) {
                                  case 0:
                                    return i = e.view._o(n), i.Nn ? [ 4 /*yield*/ , pr(t.localStore, e.query, 
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, o), [ 2 /*return*/ , ($i(t, e.targetId, s.To), 
                                    s.snapshot) ];
                                }
                            }));
                        }));
                    }(t, e, n, r);
                }, [ 4 /*yield*/ , pr(t.localStore, e, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = h.sent(), o = new Pi(e, i.Bn), s = o._o(i.documents), u = en.createSynthesizedTargetChangeForCurrentChange(n, r && "Offline" /* Offline */ !== t.onlineState), 
                a = o.applyChanges(s, 
                /* updateLimboDocuments= */ t.isPrimaryClient, u), $i(t, n, a.To), c = new Vi(e, n, o), 
...
/** Stops listening to the query. */ function qi(t, e) {
    return g(this, void 0, void 0, (function() {
        var n, r, i;
        return w(this, (function(o) {
            switch (o.label) {
              case 0:
                ...
                n.sharedClientState.removeLocalQueryTarget(r.targetId), n.sharedClientState.isActiveQueryTarget(r.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , dr(n.localStore, r.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    n.sharedClientState.clearQueryState(r.targetId), Wr(n.remoteStore, r.targetId), 
                    Xi(n, r.targetId);
                })).catch($n) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return Xi(n, r.targetId), [ 4 /*yield*/ , dr(n.localStore, r.targetId, 
        ...
        return w(this, (function(u) {
            switch (u.label) {
              case 0:
                r = function(t) {
                    var e = L(t);
                    return e.remoteStore.remoteSyncer.applySuccessfulWrite = Qi.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = zi.bind(null, e), 
                    e
                    /**
 ...
 */;
              ...
              case 1:
                return u.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = L(t), i = F.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), Je());
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Mn.pn(t, o).next((function(o) {
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                var c = a[u], h = Ie(c, n.get(c.key));
                                null != h && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                s.push(new De(c.key, h, gt(h.toProto().mapValue), we.exists(!0)));
                            }
              ...
              case 2:
                return i = u.sent(), r.sharedClientState.addPendingMutation(i.batchId), function(t, e, n) {
                    ...
                    r || (r = new xe(V)), r = r.insert(e, n), t.xo[t.currentUser.toKey()] = r;
                }(r, i.batchId, n), [ 4 /*yield*/ , eo(r, i.changes) ];

              case 3:
                return u.sent(), [ 4 /*yield*/ , oi(r.remoteStore) ];

              case 4:
                return u.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return o = u.sent(), s = vi(o, "Failed to persist write"), n.reject(s), [ 3 /*break*/ , 6 ];
    ...
    return g(this, void 0, void 0, (function() {
        ...
        return w(this, (function(i) {
            switch (i.label) {
              ...
              case 1:
                return i.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , cr(n.localStore, e) ];
              ...
              case 2:
                ...
                e.targetChanges.forEach((function(t, e) {
                    ...
                    t.addedDocuments.size > 0 ? r.bo = !0 : t.modifiedDocuments.size > 0 ? C(r.bo) : t.removedDocuments.size > 0 && (C(r.bo), 
                    r.bo = !1));
                })), [ 4 /*yield*/ , eo(n, r, e) ];
        ...
        return w(this, (function(c) {
            switch (c.label) {
              case 0:
                ...
                (o = i && i.key) ? (s = (s = new xe(rt.comparator)).insert(o, wt.newNoDocument(o, U.min())), 
                u = Je().add(o), a = new tn(U.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new je(V), s, u), [ 4 /*yield*/ , ji(r, a) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                r.Do = r.Do.remove(o), r.Co.delete(e), to(r), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , dr(r.localStore, e, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return Xi(r, e, n);
                })).catch($n) ];
    ...
    return g(this, void 0, void 0, (function() {
        ...
        return w(this, (function(o) {
            switch (o.label) {
              ...
              case 1:
                return o.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , ur(n.localStore, e) ];
              ...
              case 2:
                ...
                Yi(n, r, /*error=*/ null), Hi(n, r), n.sharedClientState.updateMutationState(r, "acknowledged"), 
                [ 4 /*yield*/ , eo(n, i) ];
        ...
        return w(this, (function(o) {
            switch (o.label) {
                ...
                return o.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        ...
                        return n._n.lookupMutationBatch(t, e).next((function(e) {
                            return C(null !== e), r = e.keys(), n._n.removeMutationBatch(t, e);
                        })).next((function() {
                            return n._n.performConsistencyCheck(t);
                        })).next((function() {
                            return n.Mn.pn(t, r);
              ...
              case 2:
                ...
                // listen events.
                Yi(r, e, n), Hi(r, e), r.sharedClientState.updateMutationState(e, "rejected", n), 
                [ 4 /*yield*/ , eo(r, i) ];
 ...
 */ function Wi(t, e) {
    return g(this, void 0, void 0, (function() {
        ...
        return w(this, (function(u) {
            switch (u.label) {
              case 0:
                $r((n = L(t)).remoteStore) || N("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                u.label = 1;
              ...
              case 3:
                return o = u.sent(), s = vi(o, "Initialization of waitForPendingWrites() operation failed"), 
...
function Ji(t, e) {
    ...
    var n = t.Do.get(e);
    null !== n && (Wr(t.remoteStore, n), t.Do = t.Do.remove(e), t.Co.delete(n), to(t));
}

function $i(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Li ? (t.No.addReference(o.key, e), Zi(t, o)) : o instanceof Oi ? (N("SyncEngine", "Document no longer in limbo: " + o.key), 
 ...
 */ function to(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.So.delete(e);
        var n = new rt(G.fromString(e)), r = t.ko.next();
        t.Co.set(r, new Mi(n)), t.Do = t.Do.insert(n, r), zr(t.remoteStore, new zn(Ht(Bt(n.path)), r, 2 /* LimboResolution */ , _.o));
    }
}
                            ...
                            switch (l.label) {
                              ...
                              case 1:
                                return l.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return jn.forEach(e, (function(e) {
                                        return jn.forEach(e.bn, (function(r) {
                                            return n.persistence.referenceDelegate.addReference(t, e.targetId, r);
                                        })).next((function() {
                                            return jn.forEach(e.vn, (function(r) {
...
function no(t, e) {
    return g(this, void 0, void 0, (function() {
        ...
        return w(this, (function(i) {
            switch (i.label) {
              case 0:
                return (n = L(t)).currentUser.isEqual(e) ? [ 3 /*break*/ , 3 ] : (N("SyncEngine", "User change. New user:", e.toKey()), 
                [ 4 /*yield*/ , sr(n.localStore, e) ]);
              ...
              case 1:
                ...
                n.sharedClientState.handleUserChange(e, r.removedBatchIds, r.addedBatchIds), [ 4 /*yield*/ , eo(n, r.Ln) ];
        ...
        return g(this, void 0, void 0, (function() {
            ...
            return w(this, (function(c) {
                switch (c.label) {
                  ...
                  case 4:
                    return n._updateProgress(Ci(r)), i = new ki(r, t.localStore, e.R), [ 4 /*yield*/ , e.Lo() ];
                  ...
                  case 11:
                    ...
                    // has newer version.
                    return u = c.sent(), [ 4 /*yield*/ , eo(t, u.wn, 
                    /* remoteEvent */ void 0) ];
                  ...
                  case 14:
                    return D("SyncEngine", "Loading bundle failed with " + (a = c.sent())), n._failWith(a), 
                    [ 3 /*break*/ , 15 ];
...
var oo = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        ...
        /** Manages our in-memory or durable persistence. */
        t, e, n, r) {
            return new or(t, e, n, r);
        }(this.persistence, new ir, t.initialUser, this.R);
    }, t.prototype.qo = function(t) {
        return new Ir(Nr.bs, this.R);
    ...
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return Gi(n.syncEngine, t, 1 /* SharedClientState */);
                    }, this.remoteStore.remoteSyncer.handleCredentialChange = no.bind(null, this.syncEngine), 
                    [ 4 /*yield*/ , fi(this.remoteStore, this.syncEngine.isPrimaryClient) ]);
        ...
        var e, n = Mr(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Pr(e));
        ...
        return e = this.localStore, n = this.datastore, r = t.asyncQueue, i = function(t) {
            return Gi(s.syncEngine, t, 0 /* RemoteStore */);
        }, o = Cr.yt() ? new Cr : new kr, new Gr(e, n, r, i, o);
    }, t.prototype.createSyncEngine = function(t, e) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        r, i, o, s) {
            var u = new Fi(t, e, n, r, i, o);
            return s && (u.Oo = !0), u;
        ...
        return function(t) {
            return g(this, void 0, void 0, (function() {
                ...
                return w(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = L(t), N("RemoteStore", "RemoteStore shutting down."), e.$r.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , Qr(e) ];
 ...
 */ var ao = /** @class */ function() {
        ...
        return g(this, void 0, void 0, (function() {
            ...
            return w(this, (function(i) {
                switch (i.label) {
                  ...
                  case 2:
                    return r = i.sent(), [ 2 /*return*/ , new Di(JSON.parse(r), t.length + n) ];
                }
            }));
        }));
    }, 
                    ...
                    return [ 4 /*yield*/ , function(t, e) {
                        return g(this, void 0, void 0, (function() {
                            ...
                            return w(this, (function(a) {
                                switch (a.label) {
                                  case 0:
                                    return n = L(t), r = En(n.R) + "/documents", i = {
                                    ...
                                    return o = a.sent(), s = new Map, o.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = bn(t, e.found.name), r = vn(e.found.updateTime), i = new mt({
                                                    mapValue: {
                                                        fields: e.found.fields
                                                    }
                                                });
                                                return wt.newFoundDocument(n, r, i);
                                            }(t, e) : "missing" in e ? function(t, e) {
                                                C(!!e.missing), C(!!e.readTime);
                                                var n = bn(t, e.missing), r = vn(e.readTime);
            ...
            return w(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    t.forEach((function(t, n) {
                        var r = rt.fromPath(n);
                        e.mutations.push(new Ve(r, e.precondition(r)));
    ...
    function t(t, e, n, r) {
        ...
        this.ec = 5, this.Zi = new Fr(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.Zi.ji((function() {
            return g(t, void 0, void 0, (function() {
                var t, e, n = this;
                return w(this, (function(r) {
                    return t = new ho(this.datastore), (e = this.sc(t)) && e.then((function(e) {
        ...
        if ("FirebaseError" === t.name) {
            ...
            var e = t.code;
            return "aborted" === e || "failed-precondition" === e || !Fe(e);
        }
        return !1;
    }, t;
}(), fo = /** @class */ function() {
    ...
    e, n) {
        var r = this;
        this.credentials = t, this.asyncQueue = e, this.databaseInfo = n, this.user = Sr.UNAUTHENTICATED, 
        this.clientId = P.u(), this.credentialListener = function() {}, this.receivedInitialUser = new Bn, 
            ...
            return g(t, void 0, void 0, (function() {
                ...
                return w(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 5:
                        return t = r.sent(), n = vi(t, "Failed to shutdown persistence"), e.reject(n), [ 3 /*break*/ , 6 ];
                    ...
                    r.isEqual(n) || (r = n, t.asyncQueue.enqueueRetryable((function() {
                        return g(i, void 0, void 0, (function() {
                            return w(this, (function(t) {
                                switch (t.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , sr(e.localStore, n) ];
...
function yo(t, e) {
    return g(this, void 0, void 0, (function() {
        ...
        return w(this, (function(i) {
            switch (i.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), [ 4 /*yield*/ , vo(t) ];
                        ...
                        return function(t, e) {
                            return g(this, void 0, void 0, (function() {
                                ...
                                return w(this, (function(i) {
                                    switch (i.label) {
                                      case 0:
                                        return (n = L(t)).asyncQueue.verifyOperationInProgress(), N("RemoteStore", "RemoteStore received new credentials"), 
                                        r = $r(n), 
                                        // Tear down and re-create our network streams. This will ensure we get a
                                        // fresh auth token for the new user and re-fill the write pipeline with
                                        // new mutations from the LocalStore (since mutations are per-user).
                                        n.$r.add(3 /* CredentialChange */), [ 4 /*yield*/ , Qr(n) ];
                                      ...
                                      case 2:
                                        return i.sent(), n.$r.delete(3 /* CredentialChange */), [ 4 /*yield*/ , Kr(n) ];
    ...
    return g(this, void 0, void 0, (function() {
        ...
        return w(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return e = r.sent(), [ 2 /*return*/ , ((n = e.eventManager).onListen = Ui.bind(null, e.syncEngine), 
                n.onUnlisten = qi.bind(null, e.syncEngine), n) ];
            }
        }));
    }));
}

/** Enables the network connection and re-enqueues all pending operations. */ function To(t, e, n) {
    var r = this;
    void 0 === n && (n = {});
    var i = new Bn;
...
function(t, e, n, r, i, o, s) {
    ...
    function t(t) {
        ...
        this.currentUser = Sr.UNAUTHENTICATED, this.receivedInitialUser = !1, 
        /**
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            t.getToken()) : n ? (C("string" == typeof n.accessToken), new Do(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.uc = function() {
        ...
        return C(null === t || "string" == typeof t), new Sr(t);
    }, t;
}(), Co = /** @class */ function() {
    function t(t, e) {
        this.ac = t, this.hc = e, this.type = "FirstParty", this.user = Sr.FIRST_PARTY;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Co(this.ac, this.hc));
    }, t.prototype.setChangeListener = function(t) {
 ...
 */ function Mo(t) {
    if (!rt.isDocumentKey(t)) throw new T(E.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function Fo(t) {
    if (rt.isDocumentKey(t)) throw new T(E.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function Uo(t) {
 ...
 */ var Bo = /** @class */ function() {
    function t(t) {
        ...
        Vo("experimentalForceLongPolling", t.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", t.experimentalAutoDetectLongPolling);
    }
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._persistenceKey = "(lite)", this._settings = new Bo({}), this._settingsFrozen = !1, 
        t instanceof No ? (this._databaseId = t, this._credentials = new Ro) : (this._app = t, 
        this._databaseId = function(t) {
            ...
            return new No(t.options.projectId);
        }(t), this._credentials = new ko(e));
    }
    return Object.defineProperty(t.prototype, "app", {
        ...
        this._settings = new Bo(t), void 0 !== t.credentials && (this._credentials = function(t) {
            if (!t) return new Ro;
            switch (t.type) {
              case "gapi":
                var e = t.client;
 ...
 */
        return t = this, (e = So.get(t)) && (N("ComponentProvider", "Removing Datastore"), 
        So.delete(t), e.terminate()), Promise.resolve();
        var t, e;
    }, t;
}(), Go = /** @class */ function() {
    /** @hideconstructor */
    ...
    return Object.defineProperty(t.prototype, "_path", {
         ...
         */
        get: function() {
            return new Qo(this.firestore, this._converter, this._key.path.popLast());
        },
        enumerable: !1,
        configurable: !0
    ...
    function e(e, n, r) {
        var i = this;
        return (i = t.call(this, e, n, Bt(r)) || this).firestore = e, i._path = r, i.type = "collection", 
        i;
    }
    return m(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        get: function() {
            ...
            return t.isEmpty() ? null : new Go(this.firestore, 
 ...
 */ function zo(t, e) {
    ...
    if (t = s(t), Oo("collection", "path", e), t instanceof jo) return Fo(n = G.fromString.apply(G, b([ e ], r))), 
    new Qo(t, /* converter= */ null, n);
    if (!(t instanceof Go || t instanceof Qo)) throw new T(E.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return Fo(n = G.fromString.apply(G, b([ t.path ], r)).child(G.fromString(e))), new Qo(t.firestore, 
    /* converter= */ null, n);
}
 ...
 */ function Wo(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = P.u()), Oo("doc", "path", e), t instanceof jo) return Mo(n = G.fromString.apply(G, b([ e ], r))), 
    new Go(t, 
    /* converter= */ null, new rt(n));
    if (!(t instanceof Go || t instanceof Qo)) throw new T(E.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return Mo(n = t._path.child(G.fromString.apply(G, b([ e ], r)))), new Go(t.firestore, t instanceof Qo ? t._converter : null, new rt(n));
}
 ...
 * Firestore database.
 */ function Ho(t, e) {
    return t = s(t), e = s(e), (t instanceof Go || t instanceof Qo) && (e instanceof Go || e instanceof Qo) && t.firestore === e.firestore && t.path === e.path && t._converter === e._converter
    /**
...
function Yo(t, e) {
    return t = s(t), e = s(e), t instanceof Ko && e instanceof Ko && t.firestore === e.firestore && Xt(t._query, e._query) && t._converter === e._converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var Xo = /** @class */ function() {
    function t() {
        ...
        this.Zi = new Fr(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.Ic = function() {
        ...
        var e = this, n = this.lc.then((function() {
            return e.mc = !0, t().catch((function(t) {
                ...
                throw e._c = t, e.mc = !1, S("INTERNAL UNHANDLED ERROR: ", 
                /**
...
var $o = /** @class */ function() {
    function t() {
        this._progressObserver = {}, this._taskCompletionResolver = new Bn, this._lastProgress = {
            taskState: "Running",
            totalBytes: 0,
            totalDocuments: 0,
            bytesLoaded: 0,
...
}(), Zo = -1, ts = /** @class */ function(t) {
    /** @hideconstructor */
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, n) || this)._queue = new Xo, r._persistenceKey = "name" in e ? e.name : "[DEFAULT]", 
        r;
    }
    return m(e, t), e.prototype._terminate = function() {
        return this._firestoreClient || 
        // The client must be initialized to ensure that all subsequent API
        // usage throws an exception.
        ns(this), this._firestoreClient.terminate();
    }, e;
}(jo);
 ...
 */
function es(t) {
    return t._firestoreClient || ns(t), t._firestoreClient.verifyNotTerminated(), t._firestoreClient;
}

function ns(t) {
    var e, n = t._freezeSettings(), r = function(t, e, n, r) {
        return new Ao(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new fo(t._credentials, t._queue, r);
}
...
var rs = /** @class */ function() {
     ...
     */    return t.fromBase64String = function(e) {
        try {
            return new t(W.fromBase64String(e));
        } catch (e) {
     ...
     */
    t.fromUint8Array = function(e) {
        return new t(W.fromUint8Array(e));
    }, 
    /**
...
}(), us = /^__.*__$/, as = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new De(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Se(t, this.data, e, this.fieldTransforms);
    }, t;
}(), cs = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var ls = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Dc = function(e) {
        ...
        return Cs(t, this.settings.methodName, this.settings.$c || !1, this.path, this.settings.Mc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (hs(this.Sc) && us.test(t)) throw this.Oc('Document fields cannot begin and end with "__"');
    }, t;
}(), fs = /** @class */ function() {
    function t(t, e, n) {
 ...
 */ function ds(t) {
    ...
    return new fs(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function ps(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.Lc(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    Ss("Data must be an object, but it was:", s, r);
    var u, a, c = As(r, s);
    if (o.merge) u = new z(s.fieldMask), a = s.fieldTransforms; else if (o.mergeFields) {
        ...
        u = new z(h), a = s.fieldTransforms.filter((function(t) {
            return u.covers(t.field);
        }));
    } else u = null, a = s.fieldTransforms;
    return new as(new mt(c), u, a);
}
...
var ys = /** @class */ function(t) {
    ...
    return m(e, t), e.prototype._toFieldTransform = function(t) {
...
var ms = /** @class */ function(t) {
    ...
    return m(e, t), e.prototype._toFieldTransform = function(t) {
        return new me(t.path, new ce);
    }, e.prototype.isEqual = function(t) {
        return t instanceof e;
    }, e;
}(os), gs = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
...
}(os), bs = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e) || this).qc = n, r;
    }
    return m(e, t), e.prototype._toFieldTransform = function(t) {
        var e = new pe(t.R, ie(t.R, this.qc));
...
/** Parse update data from an update() call. */ function _s(t, e, n, r) {
    var i = t.Lc(1 /* Update */ , e, n);
    Ss("Data must be an object, but it was:", i, r);
    var o = [], u = mt.empty();
    q(r, (function(t, r) {
        var a = ks(e, t, n);
    ...
    var a = new z(o);
    return new cs(u, a, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Es(t, e, n, r, i, o) {
    var u = t.Lc(1 /* Update */ , e, n), a = [ Ds(e, r, n) ], c = [ i ];
    ...
    for (var h = 0; h < o.length; h += 2) a.push(Ds(e, o[h])), c.push(o[h + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var l = [], f = mt.empty(), d = a.length - 1; d >= 0; --d) if (!Ls(l, a[d])) {
        var p = a[d], y = c[d];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        y = s(y);
    ...
    var g = new z(l);
    return new cs(f, g, u.fieldTransforms);
}
 ...
 */ function Ts(t, e, n, r) {
    return void 0 === r && (r = !1), Is(n, t.Lc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Is(t, e) {
    ...
    // from firestore-exp.
    t = s(t))) return Ss("Unsupported field value:", e, t), As(t, e);
    if (t instanceof os) 
    ...
    return function(t, e) {
        ...
        if (!hs(e.Sc)) throw e.Oc(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if (t instanceof F) {
            ...
            n = new F(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
            return {
                timestampValue: dn(e.R, n)
            };
        }
        ...
        if (t instanceof Go) {
            ...
            return {
                referenceValue: mn(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.Oc("Unsupported field value: " + Uo(t));
    }(t, e);
}
...
function Ns(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof F || t instanceof ss || t instanceof is || t instanceof Go || t instanceof os);
}
 ...
 */ function Ds(t, e, n) {
    ...
    // FieldPath.
    (e = s(e)) instanceof rs) return e._internalPath;
    if ("string" == typeof e) return ks(t, e);
 ...
 * evaluated.
 */ function ks(t, e, n) {
    if (e.search(Rs) >= 0) throw Cs("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return (new (rs.bind.apply(rs, b([ void 0 ], e.split(".")))))._internalPath;
    } catch (r) {
        throw Cs("Invalid field path (" + e + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}
 ...
 */ var Os = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "id", {
         ...
         */
        get: function() {
            return new Go(this._firestore, this._converter, this._key);
        },
        enumerable: !1,
        configurable: !0
    }), 
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new Ps(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(Vs("DocumentSnapshot.get", t));
 ...
 */
function Vs(t, e) {
    return "string" == typeof e ? ks(t, e) : e instanceof rs ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var Ms = /** @class */ function() {
    ...
    e.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new Us(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    e.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(Vs("DocumentSnapshot.get", t));
            if (null !== n) return this._userDataWriter.convertValue(n, e.serverTimestamps);
        }
    }, e;
}(Os), Us = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    /**
...
}(Fs), xs = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new Ms(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new Us(n._firestore, n._userDataWriter, r.key, r, new Ms(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query._converter));
        }));
    }, 
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    var r = new Us(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Ms(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query._converter);
                    return e.doc, {
                        type: "added",
                        doc: r,
                        oldIndex: -1,
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new Us(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Ms(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query._converter), i = -1, o = -1;
 ...
 */ function Bs(t, e) {
    return t instanceof Fs && e instanceof Fs ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof xs && e instanceof xs && t._firestore === e._firestore && Yo(t.query, e.query) && t.metadata.isEqual(e.metadata) && t._snapshot.isEqual(e._snapshot);
}
...
var Qs = /** @class */ function(t) {
    ...
    return m(e, t), e.prototype._apply = function(t) {
        var e = ds(t.firestore), n = function(t, e, n, r, i, o, s) {
            var u;
            if (i.isKeyField()) {
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || $s(s, o), 
            u = Ts(n, "where", s, 
            /* allowArrays= */ "in" /* IN */ === o || "not-in" /* NOT_IN */ === o);
            var f = At.create(i, o, u);
            return function(t, e) {
                if (e.g()) {
                    var n = Qt(t);
...
function Xs(t, e, n, r) {
    if (n[0] = s(n[0]), n[0] instanceof Os) return function(t, e, n, r, i) {
        ...
        // results.
        for (var o = [], s = 0, u = Wt(t); s < u.length; s++) {
            var a = u[s];
            if (a.field.isKeyField()) o.push(lt(e, r.key)); else {
                var c = r.data.field(a.field);
                if ($(c)) throw new T(E.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
    ...
    return function(t, e, n, r, i, o) {
        ...
        for (var u = [], a = 0; a < i.length; a++) {
            ...
            if (s[a].field.isKeyField()) {
                ...
                if (!zt(t) && -1 !== c.indexOf("/")) throw new T(E.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var h = t.path.child(G.fromString(c));
                if (!rt.isDocumentKey(h)) throw new T(E.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                var l = new rt(h);
                u.push(lt(e, l));
            } else {
                var f = Ts(n, r, c);
...
function Js(t, e, n) {
    if ("string" == typeof (n = s(n))) {
        ...
        if (!zt(e) && -1 !== n.indexOf("/")) throw new T(E.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(G.fromString(n));
        if (!rt.isDocumentKey(r)) throw new T(E.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return lt(t, new rt(r));
    }
    if (n instanceof Go) return lt(t, n._key);
    throw new T(E.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Uo(n) + ".");
}
 ...
 */ var tu = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new ss(X(t.latitude), X(t.longitude));
        ...
        var n = G.fromString(t);
        C(xn(n));
        var r = new No(n.get(1), n.get(3)), i = new rt(n.popFirst(5));
        return r.isEqual(e) || 
        // TODO(b/64130202): Somehow support foreign references.
        S("Document " + i + " contains a document reference within a different database (" + r.projectId + "/" + r.database + ") which is not supported. It will be treated as a reference in the current database (" + e.projectId + "/" + e.database + ") instead."), 
        i;
    }, t;
}();
...
var nu = /** @class */ function(t) {
    ...
    return m(e, t), e.prototype.convertBytes = function(t) {
        return new is(t);
    }, e.prototype.convertReference = function(t) {
        var e = this.convertDocumentKey(t, this.firestore._databaseId);
        return new Go(this.firestore, /* converter= */ null, e);
    }, e;
}(tu), ru = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, 
        this._dataReader = ds(t);
    }
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = iu(t, this._firestore), i = eu(r._converter, e, n), o = ps(this._dataReader, "WriteBatch.set", r._key, i, null !== r._converter, n);
        return this._mutations.push(o.toMutation(r._key, we.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, u = iu(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = s(e)) || e instanceof rs ? Es(this._dataReader, "WriteBatch.update", u._key, e, n, r) : _s(this._dataReader, "WriteBatch.update", u._key, e), 
        this._mutations.push(o.toMutation(u._key, we.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        this._verifyNotCommitted();
        var e = iu(t, this._firestore);
        return this._mutations = this._mutations.concat(new Pe(e._key, we.none())), this;
    }, 
    /**
 ...
 * called.
 */ function iu(t, e) {
    if ((t = s(t)).firestore !== e) throw new T(E.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ function su(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = xo(t, Go);
    var o = xo(t.firestore, ts), u = ds(o);
    return au(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = s(e)) || e instanceof rs ? Es(u, "updateDoc", t._key, e, n, r) : _s(u, "updateDoc", t._key, e)).toMutation(t._key, we.exists(!0)) ]);
}
 ...
 */ function uu(t) {
    ...
    "object" != typeof i[a] || Jo(i[a]) || (u = i[a], a++);
    var c, h, l, f = {
    ...
    if (t instanceof Go) h = xo(t.firestore, ts), l = Bt(t._key.path), c = {
        next: function(e) {
            i[a] && i[a](cu(h, t, e));
        },
        error: i[a + 1],
        ...
        var p = xo(t, Ko);
        h = xo(p.firestore, ts), l = p._query;
        var y = new ou(h);
        c = {
            next: function(t) {
                i[a] && i[a](new xs(h, y, p, t));
            },
            error: i[a + 1],
            complete: i[a + 2]
        }, js(t._query);
    ...
    return function(t, e, n, r) {
        var i = this, o = new ao(r), s = new Si(e, o, n);
        return t.asyncQueue.enqueueAndForget((function() {
            return g(i, void 0, void 0, (function() {
                var e;
                return w(this, (function(n) {
 ...
 */ function cu(t, e, n) {
    var r = n.docs.get(e._key), i = new ou(t);
    return new Fs(t, i, e._key, r, new Ms(n.hasPendingWrites, n.fromCache), e._converter);
}
 ...
 */ var hu = /** @class */ function(t) {
     ...
     */    return m(e, t), e.prototype.get = function(e) {
        var n = this, r = iu(e, this._firestore), i = new ou(this._firestore);
        return t.prototype.get.call(this, e).then((function(t) {
            return new Fs(n._firestore, i, r._key, t._document, new Ms(
            /* hasPendingWrites= */ !1, 
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = ds(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = iu(t, this._firestore), r = new nu(this._firestore);
        return this._transaction.lookup([ n._key ]).then((function(t) {
            if (!t || 1 !== t.length) return k();
            var i = t[0];
            if (i.isFoundDocument()) return new Os(e._firestore, r, i.key, i, n._converter);
            if (i.isNoDocument()) return new Os(e._firestore, r, n._key, null, n._converter);
            throw k();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = iu(t, this._firestore), i = eu(r._converter, e, n), o = ps(this._dataReader, "Transaction.set", r._key, i, null !== r._converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = s(e)) || e instanceof rs ? Es(this._dataReader, "Transaction.update", u._key, e, n, r) : _s(this._dataReader, "Transaction.update", u._key, e), 
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function lu() {
    if ("undefined" == typeof Uint8Array) throw new T(E.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function fu() {
    if ("undefined" == typeof atob) throw new T(E.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}

/** Immutable class holding a blob (binary data) */ var du = /** @class */ function() {
    function t(t) {
        this._delegate = t;
    }
    return t.fromBase64String = function(e) {
        return fu(), new t(is.fromBase64String(e));
    }, t.fromUint8Array = function(e) {
        return lu(), new t(is.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return fu(), this._delegate.toBase64();
    }, t.prototype.toUint8Array = function() {
        return lu(), this._delegate.toUint8Array();
    }, t.prototype.isEqual = function(t) {
        return this._delegate.isEqual(t._delegate);
    }, t.prototype.toString = function() {
        return "Blob(base64: " + this.toBase64() + ")";
    }, t;
}(), pu = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", yu = /** @class */ function() {
    function t() {}
    return t.prototype.enableIndexedDbPersistence = function(t, e) {
        throw new T(E.FAILED_PRECONDITION, pu);
    ...
    return Object.defineProperty(t.prototype, "_databaseId", {
                ...
                return g(e, void 0, void 0, (function() {
                    ...
                    return w(this, (function(r) {
                        switch (r.label) {
                          ...
                          case 1:
                            return e = r.sent(), [ 4 /*yield*/ , bo(t) ];

                          case 2:
                            return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                                var e = L(t);
                                return e.$r.delete(0 /* UserDisabled */), Kr(e);
                            }(n)) ];
                        }
                    }));
                }));
        ...
        /** Disables the network connection. Pending operations will not complete. */ (es(xo(this._delegate, ts)));
                            ...
                            return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                                return g(this, void 0, void 0, (function() {
                                    ...
                                    return w(this, (function(n) {
                                        switch (n.label) {
                                          case 0:
                                            return (e = L(t)).$r.add(0 /* UserDisabled */), [ 4 /*yield*/ , Qr(e) ];
 ...
 */ (es(xo(this._delegate, ts)));
    }, t.prototype.enablePersistence = function(t) {
        var e = !1, n = !1;
        return t && Vo("synchronizeTabs", e = !!t.synchronizeTabs, "experimentalForceOwningTab", n = !!t.experimentalForceOwningTab), 
 ...
 */;
        ...
        try {
            return new Cu(this, zo(this._delegate, t));
        } catch (t) {
            throw Tu(t, "collection()", "Firestore.collection()");
        }
    }, t.prototype.doc = function(t) {
        try {
            return new Eu(this, Wo(this._delegate, t));
        } catch (t) {
            throw Tu(t, "doc()", "Firestore.doc()");
        }
    }, t.prototype.collectionGroup = function(t) {
        try {
            return new Du(this, function(t, e) {
                if (t = xo(t, jo), Oo("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new T(E.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
                return new Ko(t, 
                /* converter= */ null, 
                /**
 ...
 */
                function(t) {
                    return new qt(G.emptyPath(), t);
                }(e));
            }(this._delegate, t));
        } catch (t) {
            throw Tu(t, "collectionGroup()", "Firestore.collectionGroup()");
        }
                    ...
                    return g(n, void 0, void 0, (function() {
                        ...
                        return w(this, (function(i) {
                            switch (i.label) {
                              ...
                              case 1:
                                return n = i.sent(), new lo(t.asyncQueue, n, e, r).run(), [ 2 /*return*/ ];
                            }
                        }));
                    }));
                })), r.promise;
        ...
        var t = this;
        return es(this._delegate), new bu(new ru(this._delegate, (function(e) {
            return au(t._delegate, e);
        })));
    ...
    return m(e, t), e.prototype.convertBytes = function(t) {
        return new du(new is(t));
    }, e.prototype.convertReference = function(t) {
        var e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Eu.Xc(e, this.firestore, /* converter= */ null);
    }, e;
}(tu);
 ...
 */ var wu = /** @class */ function() {
    function t(t, e) {
        this._firestore = t, this._delegate = e, this._userDataWriter = new mu(t);
    }
    return t.prototype.get = function(t) {
        var e = this, n = Lu(t);
        return this._delegate.get(n).then((function(t) {
            return new Nu(e._firestore, new Fs(e._firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, n._converter));
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Lu(t);
        return n ? (Po("Transaction.set", n), this._delegate.set(r, e, n)) : this._delegate.set(r, e), 
        this;
    }, t.prototype.update = function(t, e, n) {
    ...
    return t.prototype.set = function(t, e, n) {
        var r = Lu(t);
        return n ? (Po("WriteBatch.set", n), this._delegate.set(r, e, n)) : this._delegate.set(r, e), 
        this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i = [], o = 3; o < arguments.length; o++) i[o - 3] = arguments[o];
        var s = Lu(t);
    ...
    return t.prototype.fromFirestore = function(t, e) {
        var n = new Us(this._firestore._delegate, this._userDataWriter, t._key, t._document, t.metadata, 
        /* converter= */ null);
        return this._delegate.fromFirestore(new Su(this._firestore, n), null != e ? e : {});
    ...
    t.Zc = function(e, n) {
        ...
        var o = i.get(n);
        return o || (o = new t(e, new mu(e), n), i.set(n, o)), o;
    }, t;
}();
...
var Eu = /** @class */ function() {
    function t(t, e) {
        this.firestore = t, this._delegate = e, this._userDataWriter = new mu(t);
    }
    return t.eu = function(e, n, r) {
        ...
        return new t(n, new Go(n._delegate, r, new rt(e)));
    }, t.Xc = function(e, n, r) {
        return new t(n, new Go(n._delegate, r, e));
    }, Object.defineProperty(t.prototype, "id", {
        get: function() {
        ...
        get: function() {
            return new Cu(this.firestore, this._delegate.parent);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "path", {
        ...
        try {
            return new Cu(this.firestore, zo(this._delegate, t));
        } catch (t) {
            throw Tu(t, "collection()", "DocumentReference.collection()");
        }
    }, t.prototype.isEqual = function(t) {
        return (t = s(t)) instanceof Go && Ho(this._delegate, t);
    }, t.prototype.set = function(t, e) {
        e = Po("DocumentReference.set", e);
        try {
            return function(t, e, n) {
                t = xo(t, Go);
                var r = xo(t.firestore, ts), i = eu(t._converter, e, n);
                return au(r, [ ps(ds(r), "setDoc", t._key, i, null !== t._converter, n).toMutation(t._key, we.none()) ]);
            }(this._delegate, t, e);
        } catch (t) {
            throw Tu(t, "setDoc()", "DocumentReference.set()");
        }
    }, t.prototype.update = function(t, e) {
        for (var n = [], r = 2; r < arguments.length; r++) n[r - 2] = arguments[r];
        try {
            return 1 === arguments.length ? su(this._delegate, t) : su.apply(void 0, b([ this._delegate, t, e ], n));
        } catch (t) {
            throw Tu(t, "updateDoc()", "DocumentReference.update()");
        }
    }, t.prototype.delete = function() {
        return au(xo((t = this._delegate).firestore, ts), [ new Pe(t._key, we.none()) ]);
        var t;
        /**
 ...
 */    }, t.prototype.onSnapshot = function() {
        ...
        var r = Iu(e), i = Au(e, (function(e) {
            return new Nu(t.firestore, new Fs(t.firestore._delegate, t._userDataWriter, e._key, e._document, e.metadata, t._delegate._converter));
        }));
        return uu(this._delegate, r, i);
    }, t.prototype.get = function(t) {
        var e = this;
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            t = xo(t, Go);
            var e = xo(t.firestore, ts), n = es(e), r = new ou(e);
            return function(t, e) {
                var n = this, r = new Bn;
                return t.asyncQueue.enqueueAndForget((function() {
                    return g(n, void 0, void 0, (function() {
                                    ...
                                    return g(this, void 0, void 0, (function() {
                                        ...
                                        return w(this, (function(o) {
                                            switch (o.label) {
                                              ...
                                              case 2:
                                                return r = o.sent(), i = vi(r, "Failed to get document '" + e + " from cache"), 
                ...
                return new Fs(e, r, t._key, n, new Ms(null !== n && n.hasLocalMutations, 
                /* fromCache= */ !0), t._converter);
            }));
        }(this._delegate) : "server" === (null == t ? void 0 : t.source) ? function(t) {
            t = xo(t, Go);
            var e = xo(t.firestore, ts);
            return To(es(e), t._key, {
                source: "server"
            }).then((function(n) {
                return cu(e, t, n);
            }));
            ...
            t = xo(t, Go);
            var e = xo(t.firestore, ts);
            return To(es(e), t._key).then((function(n) {
                return cu(e, t, n);
            }));
        }(this._delegate)).then((function(t) {
            return new Nu(e.firestore, new Fs(e.firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, e._delegate._converter));
        }));
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(_u.Zc(this.firestore, e)) : this._delegate.withConverter(null));
    }, t;
}();
...
function Iu(t) {
    for (var e = 0, n = t; e < n.length; e++) {
        var r = n[e];
        if ("object" == typeof r && !Jo(r)) return r;
    }
    return {};
}
 ...
 */ function Au(t, e) {
    ...
    return {
        ...
        error: null === (n = (i = Jo(t[0]) ? t[0] : Jo(t[1]) ? t[1] : "function" == typeof t[0] ? {
            next: t[0],
            error: t[1],
            complete: t[2]
        } : {
...
var Nu = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "ref", {
        get: function() {
            return new Eu(this._firestore, this._delegate.ref);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "id", {
        ...
        return Bs(this._delegate, t._delegate);
    }, t;
}(), Su = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    ...
    return t.prototype.where = function(e, n, r) {
        try {
            ...
            return new t(this.firestore, Ks(this._delegate, function(t, e, n) {
                var r = e, i = Vs("where", t);
                return new Qs(i, r, n);
            }(e, n, r)));
        } catch (e) {
            throw Tu(e, /(orderBy|where)\(\)/, "Query.$1()");
        }
        ...
        try {
            ...
            // FieldPath Compat type as input, but is not typed as such in order to
            // not expose this via our public typings file.
            return new t(this.firestore, Ks(this._delegate, function(t, e) {
                void 0 === e && (e = "asc");
                var n = e, r = Vs("orderBy", t);
                return new zs(r, n);
            }(e, n)));
        } catch (e) {
            throw Tu(e, /(orderBy|where)\(\)/, "Query.$1()");
        ...
        try {
            return new t(this.firestore, Ks(this._delegate, function(t) {
                return qo("limit", t), new Ws("limit", t, "F" /* First */);
            }(e)));
        } catch (e) {
            throw Tu(e, "limit()", "Query.limit()");
        }
    }, t.prototype.limitToLast = function(e) {
        try {
            return new t(this.firestore, Ks(this._delegate, function(t) {
                return qo("limitToLast", t), new Ws("limitToLast", t, "L" /* Last */);
            }(e)));
        } catch (e) {
            throw Tu(e, "limitToLast()", "Query.limitToLast()");
        }
    }, t.prototype.startAt = function() {
        for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        try {
            return new t(this.firestore, Ks(this._delegate, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return new Hs("startAt", t, /*before=*/ !0);
            }.apply(void 0, e)));
        } catch (e) {
            throw Tu(e, "startAt()", "Query.startAt()");
        }
        ...
        try {
            return new t(this.firestore, Ks(this._delegate, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return new Hs("startAfter", t, 
                /*before=*/ !1);
            }.apply(void 0, e)));
        } catch (e) {
            throw Tu(e, "startAfter()", "Query.startAfter()");
        }
        ...
        try {
            return new t(this.firestore, Ks(this._delegate, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return new Ys("endBefore", t, /*before=*/ !0);
            }.apply(void 0, e)));
        } catch (e) {
            throw Tu(e, "endBefore()", "Query.endBefore()");
        }
        ...
        try {
            return new t(this.firestore, Ks(this._delegate, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return new Ys("endAt", t, /*before=*/ !1);
            }.apply(void 0, e)));
        } catch (e) {
            throw Tu(e, "endAt()", "Query.endAt()");
        }
    }, t.prototype.isEqual = function(t) {
        return Yo(this._delegate, t._delegate);
    }, t.prototype.get = function(t) {
        var e = this;
     ...
     */
        function(t) {
            ...
            return function(t, e) {
                                ...
                                return n = function(t, e, n) {
                                    return g(this, void 0, void 0, (function() {
                                        ...
                                        return w(this, (function(a) {
                                            switch (a.label) {
                                              case 0:
                                                return a.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , pr(t, e, 
                                                /* usePreviousResults= */ !0) ];

                                              case 1:
                                                return u = a.sent(), r = new Pi(e, u.Bn), i = r._o(u.documents), o = r.applyChanges(i, 
                                                /* updateLimboDocuments= */ !1), n.resolve(o.snapshot), [ 3 /*break*/ , 3 ];

                                              case 2:
                                                return s = a.sent(), u = vi(s, "Failed to execute query '" + e + " against cache"), 
                ...
                return new xs(e, r, t, n);
            }));
        }(this._delegate) : "server" === (null == t ? void 0 : t.source) ? function(t) {
            t = xo(t, Ko);
            var e = xo(t.firestore, ts), n = es(e), r = new ou(e);
            return Io(n, t._query, {
                source: "server"
            }).then((function(n) {
                return new xs(e, r, t, n);
            }));
            ...
            t = xo(t, Ko);
            var e = xo(t.firestore, ts), n = es(e), r = new ou(e);
            return js(t._query), Io(n, t._query).then((function(n) {
                return new xs(e, r, t, n);
            }));
        }(this._delegate)).then((function(t) {
            return new ku(e.firestore, new xs(e.firestore._delegate, e._userDataWriter, e._delegate, t._snapshot));
        }));
    }, t.prototype.onSnapshot = function() {
        for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        var r = Iu(e), i = Au(e, (function(e) {
            return new ku(t.firestore, new xs(t.firestore._delegate, t._userDataWriter, t._delegate, e._snapshot));
        }));
        return uu(this._delegate, r, i);
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(_u.Zc(this.firestore, e)) : this._delegate.withConverter(null));
    ...
    return Object.defineProperty(t.prototype, "type", {
        ...
        get: function() {
            return new Su(this._firestore, this._delegate.doc);
        },
        enumerable: !1,
        configurable: !0
    ...
    return Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new Du(this._firestore, this._delegate.query);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "metadata", {
        ...
        return this._delegate.docChanges(t).map((function(t) {
            return new Ru(e._firestore, t);
        }));
    }, t.prototype.forEach = function(t, e) {
        var n = this;
        this._delegate.forEach((function(r) {
            t.call(e, new Su(n._firestore, r));
        }));
    }, t.prototype.isEqual = function(t) {
        return Bs(this._delegate, t._delegate);
    }, t;
    ...
    return m(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        get: function() {
            ...
            return t ? new Eu(this.firestore, t) : null;
        },
        enumerable: !1,
        configurable: !0
    }), e.prototype.doc = function(t) {
        try {
            return new Eu(this.firestore, void 0 === t ? Wo(this._delegate) : Wo(this._delegate, t));
        } catch (t) {
            throw Tu(t, "doc()", "CollectionReference.doc()");
        }
    }, e.prototype.add = function(t) {
        var e = this;
        return function(t, e) {
            var n = xo(t.firestore, ts), r = Wo(t), i = eu(t._converter, e);
            return au(n, [ ps(ds(t.firestore), "addDoc", r._key, i, null !== t._converter, {}).toMutation(r._key, we.exists(!1)) ]).then((function() {
                return r;
            }));
        }(this._delegate, t).then((function(t) {
            return new Eu(e.firestore, t);
        }));
    }, e.prototype.isEqual = function(t) {
        return Ho(this._delegate, t._delegate);
    }, e.prototype.withConverter = function(t) {
        return new e(this.firestore, t ? this._delegate.withConverter(_u.Zc(this.firestore, t)) : this._delegate.withConverter(null));
    }, e;
}(Du);
 ...
 */ var Ou = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        this._delegate = new (rs.bind.apply(rs, b([ void 0 ], t)));
    }
    return t.documentId = function() {
         ...
         * effect is the same.
         */
        return new t(Q.keyField().canonicalString());
    }, t.prototype.isEqual = function(t) {
        return (t = s(t)) instanceof rs && this._delegate._internalPath.isEqual(t._internalPath);
    }, t;
}(), Pu = /** @class */ function() {
    function t(t) {
        this._delegate = t;
 ...
 */
    return function(t, e) {
        var n = es(t = xo(t, ts)), r = new $o;
        return function(t, e, n, r) {
            var i = this, o = function(t, e) {
                return function(t, e) {
                    return new co(t, e);
                }(function(t, e) {
                    if (t instanceof Uint8Array) return uo(t, e);
                    if (t instanceof ArrayBuffer) return uo(new Uint8Array(t), e);
...
function Mu(t) {
    ...
    }(es(e = xo(e, ts)), n).then((function(t) {
        return t ? new Ko(e, null, t.query) : null;
    }))).then((function(t) {
        return t ? new Du(r, t) : null;
    }));
}

export { vu as $, wu as B, Nu as G, Du as H, gu as L, Eu as Q, Cu as X, ku as Y, Zo as _, F as a, Pu as e, yu as k, ts as m, Vu as n, bu as q, Mu as s, Ou as t, ss as v, du as x, Su as z };
//# sourceMappingURL=prebuilt-aa849e93-0b75cd74.js.map
