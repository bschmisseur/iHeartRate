...
function loadBundle(data) {
    return database9efab86a.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return database9efab86a.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new database9efab86a.Query$1(this, 
...
registerBundle(database9efab86a.Firestore);
