...
import { base64 as u, getModularInstance as c } from "@firebase/util";
 ...
 * limitations under the License.
 */
const h = new i("@firebase/firestore");
...
function f(t, ...n) {
    if (h.logLevel <= o.DEBUG) {
        const e = n.map(m);
        h.debug(`Firestore (8.3.2): ${t}`, ...e);
    }
}

function d(t, ...n) {
    if (h.logLevel <= o.ERROR) {
        const e = n.map(m);
        h.error(`Firestore (8.3.2): ${t}`, ...e);
    }
}

function w(t, ...n) {
    if (h.logLevel <= o.WARN) {
        const e = n.map(m);
        h.warn(`Firestore (8.3.2): ${t}`, ...e);
    }
}
 ...
 */ class j {
    constructor(t, n) {
        this.u = t, this.h = n, this.type = "FirstParty", this.user = a.FIRST_PARTY;
    }
    get authHeaders() {
        const t = {
 ...
 */ class M {
    ...
    getToken() {
        return Promise.resolve(new j(this.u, this.h));
    }
    setChangeListener(t) {
...
class {
    ...
    p(t, n, e, r) {
        ...
        const i = {};
        return this.v(i, r), this.I(t, s, i, e).then((t => (f("RestConnection", "Received: ", t), 
        t)), (n => {
 ...
 */ function Pt(t) {
    const n = bt(t.mapValue.fields.__local_write_time__.timestampValue);
    ...
    switch (e) {
      ...
      case 3 /* TimestampValue */ :
        return function(t, n) {
            ...
            const e = bt(t.timestampValue), r = bt(n.timestampValue);
      ...
      case 2 /* NumberValue */ :
        return function(t, n) {
            ...
            if ("doubleValue" in t && "doubleValue" in n) {
                const e = Et(t.doubleValue), r = Et(n.doubleValue);
      ...
      case 9 /* ArrayValue */ :
        return ft(t.arrayValue.values || [], n.arrayValue.values || [], Vt);

      case 10 /* ObjectValue */ :
        return function(t, n) {
            const e = t.mapValue.fields || {}, r = n.mapValue.fields || {};
            if (mt(e) !== mt(r)) return !1;
            for (const t in e) if (e.hasOwnProperty(t) && (void 0 === r[t] || !Vt(e[t], r[t]))) return !1;
            return !0;
        }
...
function Dt(t, n) {
    ...
    switch (e) {
      ...
      case 2 /* NumberValue */ :
        return function(t, n) {
            const e = Et(t.integerValue || t.doubleValue), r = Et(n.integerValue || n.doubleValue);
      ...
      case 8 /* GeoPointValue */ :
        return function(t, n) {
            const e = lt(Et(t.latitude), Et(n.latitude));
            if (0 !== e) return e;
            return lt(Et(t.longitude), Et(n.longitude));
...
function $t(t, n) {
    ...
    const e = bt(t), r = bt(n), s = lt(e.seconds, r.seconds);
 ...
 */ class Ct {
     ...
     */    field(t) {
        return Ct.extractNestedValue(this.buildProto(), t);
    }
    ...
    isEqual(t) {
        return Vt(this.buildProto(), t.buildProto());
    }
    /**
     ...
     */    applyOverlay(t, n) {
        let e = !1;
        const r = Ct.extractNestedValue(this.partialValue, t), s = Ot(r) ? // If there is already data at the current path, base our
    ...
    static extractNestedValue(t, n) {
        if (n.isEmpty()) return t;
        {
            ...
            for (let t = 0; t < n.length - 1; ++t) {
                ...
                if (e = e.mapValue.fields[n.get(t)], !Ot(e)) return null;
            }
            return e = (e.mapValue.fields || {})[n.lastSegment()], e || null;
        }
    }
    clone() {
        return new Ct(this.buildProto());
    }
}
 ...
 */ class Lt {
     ...
     */    static newInvalidDocument(t) {
        return new Lt(t, 0 /* INVALID */ , wt.min(), Ct.empty(), 0 /* SYNCED */);
    }
    /**
     * Creates a new document that is known to exist with the given data at the
     * given version.
     */    static newFoundDocument(t, n, e) {
        return new Lt(t, 1 /* FOUND_DOCUMENT */ , n, e, 0 /* SYNCED */);
    }
    /** Creates a new document that is known to not exist at the given version. */    static newNoDocument(t, n) {
        return new Lt(t, 2 /* NO_DOCUMENT */ , n, Ct.empty(), 0 /* SYNCED */);
    }
    /**
     ...
     */    static newUnknownDocument(t, n) {
        return new Lt(t, 3 /* UNKNOWN_DOCUMENT */ , n, Ct.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }
    /**
    ...
    isEqual(t) {
        return t instanceof Lt && this.key.isEqual(t.key) && this.version.isEqual(t.version) && this.documentType === t.documentType && this.documentState === t.documentState && this.data.isEqual(t.data);
    }
    clone() {
        return new Lt(this.key, this.documentType, this.version, this.data.clone(), this.documentState);
    }
    toString() {
...
class Mt extends class {} {
     ...
     */    static create(t, n, e) {
        return t.isKeyField() ? "in" /* IN */ === n || "not-in" /* NOT_IN */ === n ? this.N(t, n, e) : new kt(t, n, e) : "array-contains" /* ARRAY_CONTAINS */ === n ? new Wt(t, e) : "in" /* IN */ === n ? new Gt(t, e) : "not-in" /* NOT_IN */ === n ? new Ht(t, e) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === n ? new Yt(t, e) : new Mt(t, n, e);
    }
    static N(t, n, e) {
        return "in" /* IN */ === n ? new Bt(t, e) : new Qt(t, e);
    }
    matches(t) {
        const n = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== n && this.D(Dt(n, this.value)) : null !== n && Rt(this.value) === Rt(n) && this.D(Dt(n, this.value));
...
/** A Filter that implements the array-contains operator. */ class Wt extends Mt {
    ...
    matches(t) {
        const n = t.data.field(this.field);
        return St(n) && Nt(n.arrayValue, this.value);
    }
}
...
/** A Filter that implements the IN operator. */ class Gt extends Mt {
    ...
    matches(t) {
        const n = t.data.field(this.field);
        return null !== n && Nt(this.value.arrayValue, n);
    }
}

/** A Filter that implements the not-in operator. */ class Ht extends Mt {
    constructor(t, n) {
...
/** A Filter that implements the array-contains-any operator. */ class Yt extends Mt {
    ...
    matches(t) {
        const n = t.data.field(this.field);
        return !(!St(n) || !n.arrayValue.values) && n.arrayValue.values.some((t => Nt(this.value.arrayValue, t)));
    }
}
 ...
 */ function on(t) {
    ...
    if (null === n.F) {
        ...
        t.isKeyField() || n.F.push(new Jt(t)), n.F.push(new Jt(G.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function un(t) {
    const n = _(t);
    if (!n.S) if ("F" /* First */ === n.limitType) n.S = jt(n.path, n.collectionGroup, on(n), n.filters, n.limit, n.startAt, n.endAt); else {
        ...
        // We need to swap the cursors to match the now-flipped query ordering.
                const e = n.endAt ? new Kt(n.endAt.position, !n.endAt.before) : null, r = n.startAt ? new Kt(n.startAt.position, !n.startAt.before) : null;
        // Now return as a LimitType.First query.
        n.S = jt(n.path, n.collectionGroup, t, n.filters, n.limit, e, r);
    }
    return n.S;
}
...
function cn(t, n) {
    return function(t, n) {
        ...
        e.op !== r.op || !e.field.isEqual(r.field) || !Vt(e.value, r.value)) return !1;
        var e, r;
...
/** A mutation that deletes the document at the given key. */ class vn extends yn {
    constructor(t, n) {
...
function qn(t, n) {
    return "found" in n ? function(t, n) {
        ...
        const e = $n(t, n.found.name), r = Vn(n.found.updateTime), s = new Ct({
            mapValue: {
                fields: n.found.fields
            }
        });
        return Lt.newFoundDocument(e, r, s);
    }(t, n) : "missing" in n ? function(t, n) {
        y(!!n.missing), y(!!n.readTime);
        const e = $n(t, n.missing), r = Vn(n.readTime);
        return Lt.newNoDocument(e, r);
    }(t, n) : p();
}
...
function Cn(t, n) {
    ...
    null !== n.collectionGroup ? (e.parent = Fn(t, r), e.structuredQuery.from = [ {
        collectionId: n.collectionGroup,
        allDescendants: !0
    } ]) : (e.parent = Fn(t, r.popLast()), e.structuredQuery.from = [ {
...
class zn {
     ...
     */    H(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                r > 0 && f("ExponentialBackoff", `Backing off for ${r} ms (base delay: ${this.k} ms, delay with jitter: ${n} ms, last attempt: ${e} ms ago)`), 
...
class Wn extends class {} {
    ...
    X() {
        if (this.Z) throw new O(N, "The client has already been terminated.");
    }
...
async function Gn(t, n) {
    const e = _(t), r = Sn(e.O) + "/documents", s = {
        writes: n.map((t => On(e.O, t)))
    };
...
async function Yn(t, n) {
    const e = _(t), r = Cn(e.O, un(n));
    return (await e.T("RunQuery", r.parent, {
        structuredQuery: r.structuredQuery
    })).filter((t => !!t.document)).map((t => function(t, n, e) {
        const r = $n(t, n.name), s = Vn(n.updateTime), i = new Ct({
            mapValue: {
                fields: n.fields
            }
        }), o = Lt.newFoundDocument(r, s, i);
...
function Jn(t) {
    ...
    if (!Kn.has(t)) {
        ...
        new k(n, e, r, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling))), o = Qn(t._databaseId), u = function(t, n, e) {
            return new Wn(t, n, e);
        }(t._credentials, i, o);
        Kn.set(t, u);
    }
 ...
 */ (t), this._credentials = new U(n));
     ...
     */    _terminate() {
        return function(t) {
            const n = Kn.get(t);
            n && (f("ComponentProvider", "Removing Datastore"), Kn.delete(t), n.terminate());
 ...
 * terminated.
 */ function re(t) {
    return t = X(t, Xn), n(t.app, "firestore/lite"), t._delete();
}
...
class se {
     ...
     */    get parent() {
        return new oe(this.firestore, this._converter, this._key.path.popLast());
    }
    withConverter(t) {
        return new se(this.firestore, t, this._key);
    }
}
 ...
 */ class ie {
    ...
    withConverter(t) {
        return new ie(this.firestore, t, this._query);
    }
}
 ...
 */ class oe extends ie {
    /** @hideconstructor */
    constructor(t, n, e) {
        super(t, n, new tn(e)), this.firestore = t, this._path = e, this.type = "collection";
    }
     ...
     */    get parent() {
        ...
        return t.isEmpty() ? null : new se(this.firestore, 
        /* converter= */ null, new H(t));
    }
    withConverter(t) {
        return new oe(this.firestore, t, this._path);
    }
}

function ue(t, n, ...e) {
    if (t = c(t), Y("collection", "path", n), t instanceof Xn) {
        const r = z.fromString(n, ...e);
        return J(r), new oe(t, /* converter= */ null, r);
    }
    {
        if (!(t instanceof se || t instanceof oe)) throw new O(E, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const r = z.fromString(t.path, ...e).child(z.fromString(n));
        return J(r), new oe(t.firestore, 
        /* converter= */ null, r);
    }
}
 ...
 */ function ce(t, n) {
    if (t = X(t, Xn), Y("collectionGroup", "collection id", n), n.indexOf("/") >= 0) throw new O(E, `Invalid collection ID '${n}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new ie(t, 
    /* converter= */ null, 
    /**
...
function ae(t, n, ...e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = ht.R()), Y("doc", "path", n), t instanceof Xn) {
        const r = z.fromString(n, ...e);
        return K(r), new se(t, 
    ...
    }
    {
        ...
        return K(r), new se(t.firestore, t instanceof oe ? t._converter : null, new H(r));
    }
}
 ...
 * Firestore database.
 */ function he(t, n) {
    return t = c(t), n = c(n), (t instanceof se || t instanceof oe) && (n instanceof se || n instanceof oe) && (t.firestore === n.firestore && t.path === n.path && t._converter === n._converter);
}
 ...
 * Firestore database.
 */ function le(t, n) {
    return t = c(t), n = c(n), t instanceof ie && n instanceof ie && (t.firestore === n.firestore && cn(t._query, n._query) && t._converter === n._converter);
}
 ...
 */ class we {
     ...
     */    static fromBase64String(t) {
        try {
            return new we(gt.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new we(gt.fromUint8Array(t));
    }
    /**
...
/** The result of parsing document data (e.g. for a setData call). */ class _e {
    constructor(t, n, e) {
...
/** A "context" object passed around while parsing user data. */ class be {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */    et(t) {
        return new be(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.O, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    rt(t) {
        var n;
    ...
    ct(t) {
        return Me(t, this.settings.methodName, this.settings.at || !1, this.path, this.settings.ht);
    }
    ...
    it(t) {
        ...
        if (ve(this.nt) && ye.test(t)) throw this.ct('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class Ee {
    constructor(t, n, e) {
        this.databaseId = t, this.ignoreUndefinedProperties = n, this.O = e || Qn(t);
    }
...
function Ie(t) {
    ...
    return new Ee(t._databaseId, !!n.ignoreUndefinedProperties, e);
}
...
class Ve extends me {
    ...
    _toFieldTransform(t) {
        const n = Pe(this, t, 
        /*array=*/ !0), e = this.ft.map((t => xe(t, n))), r = new fn(e);
...
class Ne extends me {
    ...
    _toFieldTransform(t) {
        const n = Pe(this, t, 
        /*array=*/ !0), e = this.ft.map((t => xe(t, n))), r = new dn(e);
        return new mn(t.path, r);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class De extends me {
    ...
    _toFieldTransform(t) {
        const n = new wn(t.O, an(t.O, this.dt));
...
/** Parse update data from an update() call. */ function $e(t, n, e, r) {
    ...
    const u = new yt(i);
    return new ge(o, u, s.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Fe(t, n, e, r, s, i) {
    const o = t.lt(1 /* Update */ , n, e), u = [ Le(n, r, e) ], a = [ s ];
    ...
    for (let t = u.length - 1; t >= 0; --t) if (!ke(h, u[t])) {
        const n = u[t];
        let e = a[t];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
    ...
    const f = new yt(h);
    return new ge(l, f, o.fieldTransforms);
}
 ...
 */ function Se(t, n, e, r = !1) {
    return xe(e, t.lt(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , n));
}
 ...
 */ function xe(t, n) {
    ...
    // from firestore-exp.
    t = c(t))) return Ce("Unsupported field value:", n, t), qe(t, n);
    if (t instanceof me) 
 ...
 */
    return function(t, n) {
        ...
        if (!ve(n.nt)) throw n.ct(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, n), null;
    ...
    return function(t, n) {
        ...
        if ("number" == typeof t) return an(n.O, t);
        ...
        if (t instanceof we) return {
            bytesValue: Pn(n.O, t._byteString)
        };
        if (t instanceof se) {
        ...
        throw n.ct(`Unsupported field value: ${Z(t)}`);
    }
    /**
...
function Oe(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof dt || t instanceof pe || t instanceof we || t instanceof se || t instanceof me);
}
 ...
 */ function Le(t, n, e) {
    ...
    // FieldPath.
    n = c(n)) instanceof fe) return n._internalPath;
 ...
 * evaluated.
 */ function je(t, n, e) {
    if (n.search(Ue) >= 0) throw Me(`Invalid field path (${n}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, e);
    try {
        return new fe(...n.split("."))._internalPath;
    } catch (r) {
 ...
 */ class Be {
     ...
     */    data() {
        if (this._document) {
            if (this._converter) {
                ...
                const t = new Qe(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    get(t) {
        if (this._document) {
            const n = this._document.data.field(Ge("DocumentSnapshot.get", t));
 ...
 */ function We(t, n) {
    return t = c(t), n = c(n), t instanceof Be && n instanceof Be ? t._firestore === n._firestore && t._key.isEqual(n._key) && (null === t._document ? null === n._document : t._document.isEqual(n._document)) && t._converter === n._converter : t instanceof ze && n instanceof ze && (le(t.query, n.query) && ft(t.docs, n.docs, We));
}

/**
 * Helper that calls fromDotSeparatedString() but wraps any error thrown.
 */ function Ge(t, n) {
    return "string" == typeof n ? je(t, n) : n instanceof fe ? n._internalPath : n._delegate._internalPath;
}
...
class Ke extends He {
    ...
    _apply(t) {
        const n = Ie(t.firestore), e = function(t, n, e, r, s, i, o) {
            let u;
            if (s.isKeyField()) {
                ...
                if ("in" /* IN */ === i || "not-in" /* NOT_IN */ === i) {
                    lr(o, i);
                    const n = [];
                    for (const e of o) n.push(hr(r, t, e));
                    u = {
                        arrayValue: {
                            values: n
                        }
            ...
            } else "in" /* IN */ !== i && "not-in" /* NOT_IN */ !== i && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== i || lr(o, i), 
            u = Se(e, n, o, 
 ...
 */
        ...
        return new ie(t.firestore, t._converter, function(t, n) {
            const e = t.filters.concat([ n ]);
            return new tn(t.path, t.collectionGroup, t.explicitOrderBy.slice(), e, t.limit, t.limitType, t.startAt, t.endAt);
        }(t._query, e));
    }
}
...
class tr extends He {
    ...
    _apply(t) {
        return new ie(t.firestore, t._converter, function(t, n, e) {
            return new tn(t.path, t.collectionGroup, t.explicitOrderBy.slice(), t.filters.slice(), n, e, t.startAt, t.endAt);
 ...
 * @returns The created `Query`.
 */ function nr(t) {
    return tt("limit", t), new tr("limit", t, "F" /* First */);
}
 ...
 * @returns The created `Query`.
 */ function er(t) {
    return tt("limitToLast", t), new tr("limitToLast", t, "L" /* Last */);
}
...
class rr extends He {
    ...
    _apply(t) {
        const n = ar(t, this.type, this.Et, this.It);
        return new ie(t.firestore, t._converter, function(t, n) {
            return new tn(t.path, t.collectionGroup, t.explicitOrderBy.slice(), t.filters.slice(), t.limit, t.limitType, n, t.endAt);
        }(t._query, n));
    }
}
...
class or extends He {
    ...
    _apply(t) {
        const n = ar(t, this.type, this.Et, this.It);
        return new ie(t.firestore, t._converter, function(t, n) {
            return new tn(t.path, t.collectionGroup, t.explicitOrderBy.slice(), t.filters.slice(), t.limit, t.limitType, t.startAt, n);
        }(t._query, n));
    }
}

function ur(...t) {
    return new or("endBefore", t, /*before=*/ !0);
}

function cr(...t) {
    return new or("endAt", t, /*before=*/ !1);
}

/** Helper function to create a bound from a document or fields */ function ar(t, n, e, r) {
    if (e[0] = c(e[0]), e[0] instanceof Be) return function(t, n, e, r, s) {
        ...
        // results.
                for (const e of on(t)) if (e.field.isKeyField()) i.push(Ft(n, r.key)); else {
            const t = r.data.field(e.field);
            if (Tt(t)) throw new O(E, 'Invalid query. You are trying to start or end a query using a document for which the field "' + e.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
        ...
        return function(t, n, e, r, s, i) {
            ...
            for (let i = 0; i < s.length; i++) {
                ...
                if (o[i].field.isKeyField()) {
                    ...
                    if (!sn(t) && -1 !== c.indexOf("/")) throw new O(E, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${r}() must be a plain document ID, but '${c}' contains a slash.`);
...
function hr(t, n, e) {
    if ("string" == typeof (e = c(e))) {
        ...
        if (!sn(n) && -1 !== e.indexOf("/")) throw new O(E, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${e}' contains a '/' character.`);
    ...
    if (e instanceof se) return Ft(t, e._key);
...
class wr extends class {
    ...
    convertGeoPoint(t) {
        return new pe(Et(t.latitude), Et(t.longitude));
    }
    convertArray(t, n) {
    ...
    convertReference(t) {
        ...
        return new se(this.firestore, /* converter= */ null, n);
    }
}
 ...
 * document contents.
 */ function mr(t) {
    const n = Jn((t = X(t, se)).firestore), e = new wr(t.firestore);
    return Hn(n, [ t._key ]).then((n => {
        y(1 === n.length);
        const r = n[0];
        return new Be(t.firestore, e, t._key, r.isFoundDocument() ? r : null, t._converter);
    }));
}
 ...
 */ function pr(t) {
    !function(t) {
        if (nn(t) && 0 === t.explicitOrderBy.length) throw new O(F, "limitToLast() queries require specifying at least one orderBy() clause");
    }((t = X(t, ie))._query);
    const n = Jn(t.firestore), e = new wr(t.firestore);
    return Yn(n, t._query).then((n => {
        const r = n.map((n => new Qe(t.firestore, e, n.key, n, t._converter)));
        return nn(t._query) && 
...
function yr(t, n, e) {
    const r = dr((t = X(t, se))._converter, n, e), s = Te(Ie(t.firestore), "setDoc", t._key, r, null !== t._converter, e);
    return Gn(Jn(t.firestore), [ s.toMutation(t._key, pn.none()) ]);
}

function _r(t, n, e, ...r) {
    const s = Ie((t = X(t, se)).firestore);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
        let i;
    i = "string" == typeof (n = c(n)) || n instanceof fe ? Fe(s, "updateDoc", t._key, n, e, r) : $e(s, "updateDoc", t._key, n);
 ...
 */ function gr(t) {
    return Gn(Jn((t = X(t, se)).firestore), [ new vn(t._key, pn.none()) ]);
}
 ...
 */ function vr(t, n) {
    const e = ae(t = X(t, oe)), r = dr(t._converter, n), s = Te(Ie(t.firestore), "addDoc", e._key, r, null !== e._converter, {});
    return Gn(Jn(t.firestore), [ s.toMutation(e._key, pn.exists(!1)) ]).then((() => e));
}
 ...
 */ class Pr {
    ...
    constructor(t, n) {
        ...
        this._dataReader = Ie(t);
    }
    set(t, n, e) {
        this._verifyNotCommitted();
        const r = Rr(t, this._firestore), s = dr(r._converter, n, e), i = Te(this._dataReader, "WriteBatch.set", r._key, s, null !== r._converter, e);
        return this._mutations.push(i.toMutation(r._key, pn.none())), this;
    }
    update(t, n, e, ...r) {
        this._verifyNotCommitted();
        const s = Rr(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let i;
        return i = "string" == typeof (n = c(n)) || n instanceof fe ? Fe(this._dataReader, "WriteBatch.update", s._key, n, e, r) : $e(this._dataReader, "WriteBatch.update", s._key, n), 
        this._mutations.push(i.toMutation(s._key, pn.exists(!0))), this;
    }
    /**
     ...
     */    delete(t) {
        this._verifyNotCommitted();
        const n = Rr(t, this._firestore);
        return this._mutations = this._mutations.concat(new vn(n._key, pn.none())), this;
    }
    /**
 ...
 */ class Nr {
    ...
    async lookup(t) {
        ...
        const n = await Hn(this.datastore, t);
    ...
    async commit() {
        ...
        t.forEach(((t, n) => {
            ...
            this.mutations.push(new bn(e, this.precondition(e)));
...
class Dr {
    constructor(t, n, e, r) {
        ...
        this.Tt = 5, this.At = new zn(this.asyncQueue, "transaction_retry" /* TransactionRetry */);
    }
    ...
    Pt() {
        this.At.H((async () => {
            const t = new Nr(this.datastore), n = this.Rt(t);
            n && n.then((n => {
 ...
 */ class Fr {
     ...
     */    static createAndSchedule(t, n, e, r, s) {
        const i = Date.now() + e, o = new Fr(t, n, i, r, s);
        return o.start(e), o;
    }
    /**
 ...
 */ class Sr {
    constructor() {
        ...
        this.At = new zn(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Ct = () => {
            const t = $r();
            t && f("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.At.K();
        };
        const t = $r();
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, n, e) {
        ...
        const r = Fr.createAndSchedule(this, t, n, e, (t => this.Mt(t)));
...
class xr {
    /** @hideconstructor */
    constructor(t, n) {
        this._firestore = t, this._transaction = n, this._dataReader = Ie(t);
    }
    /**
     ...
     */    get(t) {
        const n = Rr(t, this._firestore), e = new wr(this._firestore);
        return this._transaction.lookup([ n._key ]).then((t => {
            if (!t || 1 !== t.length) return p();
            const r = t[0];
            if (r.isFoundDocument()) return new Be(this._firestore, e, r.key, r, n._converter);
            if (r.isNoDocument()) return new Be(this._firestore, e, n._key, null, n._converter);
            throw p();
        }));
    }
    set(t, n, e) {
        const r = Rr(t, this._firestore), s = dr(r._converter, n, e), i = Te(this._dataReader, "Transaction.set", r._key, s, null !== r._converter, e);
    ...
    update(t, n, e, ...r) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (n = c(n)) || n instanceof fe ? Fe(this._dataReader, "Transaction.update", s._key, n, e, r) : $e(this._dataReader, "Transaction.update", s._key, n), 
 ...
 */ function qr(t, n) {
    const e = Jn(t = X(t, Xn)), r = new ct;
    return new Dr(new Sr, e, (e => n(new xr(t, e))), r).run(), r.promise;
}
 ...
 */ e(new s("firestore/lite", ((t, {options: n}) => {
    const e = t.getProvider("app-exp").getImmediate(), r = new Xn(e, t.getProvider("auth-internal"));
    return n && r._setSettings(n), r;
}), "PUBLIC" /* PUBLIC */)), r("firestore-lite", "2.2.2", "node");

export { we as Bytes, oe as CollectionReference, se as DocumentReference, Be as DocumentSnapshot, fe as FieldPath, me as FieldValue, Xn as FirebaseFirestore, O as FirestoreError, pe as GeoPoint, ie as Query, He as QueryConstraint, Qe as QueryDocumentSnapshot, ze as QuerySnapshot, dt as Timestamp, xr as Transaction, Pr as WriteBatch, vr as addDoc, Tr as arrayRemove, Ir as arrayUnion, ue as collection, ce as collectionGroup, gr as deleteDoc, br as deleteField, ae as doc, de as documentId, cr as endAt, ur as endBefore, mr as getDoc, pr as getDocs, ne as getFirestore, Ar as increment, te as initializeFirestore, nr as limit, er as limitToLast, Xe as orderBy, Ye as query, le as queryEqual, he as refEqual, qr as runTransaction, Er as serverTimestamp, yr as setDoc, l as setLogLevel, We as snapshotEqual, ir as startAfter, sr as startAt, re as terminate, _r as updateDoc, ee as useFirestoreEmulator, Je as where, Vr as writeBatch };
