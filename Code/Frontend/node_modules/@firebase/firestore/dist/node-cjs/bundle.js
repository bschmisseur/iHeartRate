...
function loadBundle(data) {
    return databaseA9536f18.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    var _this = this;
    return databaseA9536f18.namedQuery(this._delegate, queryName).then(function (expQuery) {
        if (!expQuery) {
            return null;
        }
        return new databaseA9536f18.Query$1(_this, 
...
registerBundle(databaseA9536f18.Firestore);
