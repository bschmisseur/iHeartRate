...
export declare class Query {
    ...
    static set __referenceConstructor(val: new (database: Database, path: Path) => Query);
    static get __referenceConstructor(): new (database: Database, path: Path) => Query;
    readonly repo: Repo;
    constructor(database: Database, path: Path, queryParams_: QueryParams, orderByCalled_: boolean);
    /**
