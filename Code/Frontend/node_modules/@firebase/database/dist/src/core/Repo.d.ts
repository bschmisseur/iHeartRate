...
export declare class Repo {
    ...
    onDisconnect_: import("./SparseSnapshotTree").SparseSnapshotTree;
...
export declare function repoStart(repo: Repo): void;
/**
 ...
 */
export declare function repoGetValue(repo: Repo, query: Query): Promise<Node>;
...
export declare function repoAddEventCallbackForQuery(repo: Repo, query: Query, eventRegistration: EventRegistration): void;
export declare function repoRemoveEventCallbackForQuery(repo: Repo, query: Query, eventRegistration: EventRegistration): void;
