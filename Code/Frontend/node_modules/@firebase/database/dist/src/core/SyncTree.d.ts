...
export declare class SyncTree {
     ...
     */
    pendingWriteTree_: import("./WriteTree").WriteTree;
 ...
 */
export declare function syncTreeRemoveEventRegistration(syncTree: SyncTree, query: Query, eventRegistration: EventRegistration | null, cancelError?: Error): Event[];
/**
 ...
 * @return Events to raise.
 */
export declare function syncTreeAddEventRegistration(syncTree: SyncTree, query: Query, eventRegistration: EventRegistration): Event[];
/**
...
export declare function syncTreeGetServerValue(syncTree: SyncTree, query: Query): Node | null;
