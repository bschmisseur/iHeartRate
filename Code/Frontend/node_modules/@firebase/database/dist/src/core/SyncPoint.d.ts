 ...
 */
export declare function syncPointGetView(syncPoint: SyncPoint, query: Query, writesCache: WriteTreeRef, serverCache: Node | null, serverCacheComplete: boolean): View;
/**
 ...
 * @return Events to raise.
 */
export declare function syncPointAddEventRegistration(syncPoint: SyncPoint, query: Query, eventRegistration: EventRegistration, writesCache: WriteTreeRef, serverCache: Node | null, serverCacheComplete: boolean): Event[];
/**
 ...
 */
export declare function syncPointRemoveEventRegistration(syncPoint: SyncPoint, query: Query, eventRegistration: EventRegistration | null, cancelError?: Error): {
    removed: Query[];
    events: Event[];
};
...
export declare function syncPointViewForQuery(syncPoint: SyncPoint, query: Query): View | null;
export declare function syncPointViewExistsForQuery(syncPoint: SyncPoint, query: Query): boolean;
